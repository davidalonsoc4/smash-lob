...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.4.18", date: "9 de agosto de 2026", title: "Emparejamiento con VS flotante", summary: "El detalle de partido alinea por completo la Pareja B a la derecha y recupera un VS más pequeño centrado respecto a los nombres, sin restarles ancho.", category: "improvement", changes: ["Pareja B alinea a la derecha título, nombres, posición y textos auxiliares.", "El El VS se hace más pequeño y flota centrado entre las columnas de nombres, sin ocupar una tercera columna ni tomar como referencia la fila de avatares."] },
