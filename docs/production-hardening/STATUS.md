...
- Ajuste pendiente de prueba en PRE v1.14.0: el contenido principal del precinto de bolsa gana tamaño de impresión, conservando sin escala la firma de Smash & Lob.
