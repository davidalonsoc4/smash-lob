...
- Tras completar la extracción de reglas (`be3641d`), la validación volvió a pasar en 768 tests unitarios, build de producción y 68 E2E; `npm audit --omit=dev --audit-level=high` quedó temporalmente bloqueado por un 503 de mantenimiento del endpoint de npm y debe repetirse cuando el servicio se recupere.
