...
assert(detailPairingPanel.includes('grid grid-cols-2 items-start gap-2') && !detailPairingPanel.includes('grid-cols-[minmax(0,1fr)_42px_minmax(0,1fr)]'), "El detalle debe usar dos columnas completas sin reservar ancho para VS")
assert(!detailPairingPanel.includes('>\n            VS\n          </span>'), "El panel de detalle no debe mostrar VS")
