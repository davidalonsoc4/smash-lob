...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.14", date: "16 de septiembre de 2026", title: "Cinco conceptos para la faja del bote", summary: "La vista previa de la faja incorpora cinco propuestas visuales independientes para comparar personalidad e información.", category: "new", changes: ["Se muestran debajo del diseño actual cinco conceptos de prueba: roster limpio, edición limitada, manifiesto de liga, iniciales como patrón y edición coleccionable.", "Las propuestas son solo previews y no alteran el diseño actual ni la generación de PDFs."] },
