...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.21", date: "16 de septiembre de 2026", title: "Tamaño de nombre aplicado al PDF", summary: "El ajuste de tamaño de los nombres de la faja se fuerza también sobre la copia preparada para impresión.", category: "fix", changes: ["La preview y el clon de impresión reciben el mismo tamaño, evitando que el PDF ignore el valor elegido."] },
