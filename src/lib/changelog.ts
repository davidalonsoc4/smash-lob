...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.15.4", date: "19 de septiembre de 2026", title: "Saneamiento y robustez de la aplicación", summary: "La rama reúne la limpieza de i18n, notificaciones persistentes, auditoría, lista de espera, cuenta y refactors de mantenimiento.", category: "foundation", changes: ["Trabajo en curso sobre la base v1.15.3; no se publica automáticamente."] },
  { version: "v1.15.3", date: "19 de septiembre de 2026", title: "Color de tinta para las pegatinas", summary: "Elige si las zonas blancas de las pegatinas se preparan en gris claro o en blanco.", category: "improvement", changes: ["La plancha de pegatinas permite cambiar entre gris claro y blanco antes de revisar la vista previa o generar el PDF.", "El gris claro sigue seleccionado por defecto y se mantiene la transparencia de los diseños."] },
  { version: "v1.15.2", date: "18 de septiembre de 2026", title: "Pegatinas para Welcome Pack", summary: "El Welcome Pack permite preparar una hoja A4 con los diseños de pegatinas de la liga.", category: "new", changes: ["Selecciona cualquiera de los seis diseños, ajusta cuántas copias quieres de cada uno y conserva las proporciones.", "El sistema calcula el tamaño máximo para que todos los diseños y sus copias quepan en una sola hoja A4, indica la orientación y completa los huecos útiles con logos de la liga.", "La hoja mantiene separación cero entre diseños y un margen exterior de seguridad de 5 mm."] },
  { version: "v1.15.0", date: "17 de septiembre de 2026", title: "Espectadores sin cuenta", summary: "La experiencia pública de espectadores se publica en la versión 1.15, accesible desde el enlace o el QR de la liga.", category: "new", changes: ["Los espectadores pueden consultar partidos, resultados y clasificación sin iniciar sesión.", "La vista pública omite chats, actividad interna, pagos, incidencias y datos de cuenta, y respeta los periodos secretos y la publicación progresiva del calendario.", "El acceso depende del enlace activo de la liga, que la organización puede desactivar."] },
  { version: "v1.14.40", date: "17 de septiembre de 2026", title: "Espectadores sin cuenta", summary: "Los enlaces y el QR de la liga abren una vista pública de solo lectura sin pedir iniciar sesión.", category: "new", changes: ["Los espectadores pueden consultar partidos, resultados y clasificación desde el enlace de invitación o el QR de la liga sin crear una cuenta.", "La vista pública omite chats, actividad interna, pagos, incidencias y datos de cuenta, y respeta los periodos secretos y la publicación progresiva del calendario.", "El acceso sigue dependiendo del enlace activo de la liga, que la organización puede desactivar."] },
  { version: "v1.14.39", date: "17 de septiembre de 2026", title: "Custodios claros en cada partido", summary: "El selector gana presencia visual y el aviso solo se muestra a quien lleva las bolas.", category: "improvement", changes: ["La selección de custodios usa tarjetas con avatar y estado visual, tanto al crear como al editar una temporada.", "Las tarjetas de Home y Calendario ya no muestran el nombre del custodio; solo la persona asignada ve el mensaje directo «Eres el encargado de las bolas»."] },
  { version: "v1.14.38", date: "17 de septiembre de 2026", title: "Selección de custodios y avisos en el momento adecuado", summary: "La organización puede elegir quién está habilitado para custodiar las bolas, y los avisos de partidos respetan el inicio real de la temporada.", category: "improvement", changes: ["Al crear o configurar una temporada se puede definir un orden de prioridad o seleccionar directamente el grupo de custodios elegibles.", "El reparto comprueba que los custodios seleccionados puedan cubrir los partidos; todos los encuentros de la Jornada de Apertura siguen asignados al organizador.", "Los avisos y recordatorios de custodio solo se generan cuando el partido está programado y no aparecen durante la fase secreta ni antes del inicio de la temporada."] },
  { version: "v1.14.37", date: "17 de septiembre de 2026", title: "QR de espectadores con identidad de marca", summary: "El código QR incorpora el icono de Smash & Lob y gana contraste y margen para facilitar el escaneo.", category: "improvement", changes: ["El SVG descargable integra el icono de la app en una placa central y usa módulos en un tono carbón.", "El margen blanco alrededor del código mide cuatro módulos y se conserva la corrección de errores alta."] },
  { version: "v1.14.36", date: "17 de septiembre de 2026", title: "Popup QR integrado con el tema", summary: "La ventana de invitación adopta los colores de superficie del tema activo y deja el dorado fuera del diálogo.", category: "improvement", changes: ["El fondo, los textos y las acciones del popup siguen la paleta de la aplicación.", "El QR conserva su tarjeta blanca para facilitar el escaneo en cualquier tema."] },
  { version: "v1.14.35", date: "17 de septiembre de 2026", title: "Diseño renovado para compartir el QR", summary: "La invitación de espectadores presenta el QR de la liga en una ventana más cuidada, legible y adaptada a móvil.", category: "improvement", changes: ["El diálogo del QR refuerza la identidad de la liga, separa visualmente el código de la explicación y destaca descargar y compartir con iconos."] },
  { version: "v1.14.34", date: "17 de septiembre de 2026", title: "QR de liga y actualizaciones en pausa segura", summary: "Compartir abre un QR descargable que lleva al acceso de espectadores de toda la liga; las nuevas versiones se aplican tras un periodo de inactividad y cuando no interrumpen una acción.", category: "improvement", changes: ["El botón flotante genera y muestra un QR vectorial del enlace de espectadores de la liga, con opciones para descargarlo o compartir el enlace directamente.", "La PWA activa las versiones pendientes tras un minuto sin actividad, con la aplicación enfocada y visible, sin diálogo abierto ni campo editable activo."] },
  { version: "v1.14.33", date: "17 de septiembre de 2026", title: "Reparto completo en la Jornada de Apertura", summary: "El organizador se encarga de todos los partidos de la Jornada 1 y el reparto normal comienza en la Jornada 2.", category: "fix", changes: ["Se asigna al organizador un bote por cada partido de la Jornada 1, aunque haya más de dos.", "Desde la Jornada 2, los encargos y el conteo siguen el reparto normal."] },
  { version: "v1.14.32", date: "17 de septiembre de 2026", title: "Jornada de Apertura y reparto de bolas", summary: "Los dos primeros partidos de la Jornada 1 quedan a cargo del organizador y el reparto automático continúa desde el resto de la temporada.", category: "fix", changes: ["Los dos botes de apertura se asignan a los dos primeros partidos de la Jornada 1 y no se duplican en el total.", "El buscador de ajustes lleva a la configuración de bolas asignadas por la organización con términos de búsqueda relacionados."] },
  { version: "v1.14.31", date: "16 de septiembre de 2026", title: "Jornada de Apertura y avisos del custodio", summary: "Los dos botes de apertura quedan asignados al creador y el encargado de cada partido recibe un aviso y un recordatorio dos horas antes.", category: "improvement", changes: ["El cálculo suma los dos botes de la Jornada de Apertura al creador de la liga sin alterar el reparto de encargos por partido.", "El custodio recibe un aviso personal al asignársele un partido y un recordatorio dos horas antes.", "Los avisos personales solo son visibles y se envían al jugador encargado."] },
  { version: "v1.14.30", date: "16 de septiembre de 2026", title: "Prioridad de custodios corregida", summary: "Las flechas de prioridad ahora reordenan correctamente a todos los jugadores al crear o editar una temporada.", category: "fix", changes: ["Subir y bajar funcionan también cuando algunos jugadores todavía no estaban guardados en el orden anterior."] },
  { version: "v1.14.29", date: "16 de septiembre de 2026", title: "Reparto de botes más claro", summary: "La configuración de bolas asignadas muestra cada custodio y sus botes, con un acceso directo desde los ajustes de temporada.", category: "improvement", changes: ["El reparto muestra cuántos botes corresponden a cada custodio.", "La navegación de temporada incorpora un acceso directo al bloque de bolas asignadas.", "En temporadas con autoinscripción, el reparto espera a que la plantilla esté completa y se genere el calendario."] },
  { version: "v1.14.28", date: "16 de septiembre de 2026", title: "Configuración de custodios de bolas más fiable", summary: "La prioridad de custodios muestra también los jugadores que se están incorporando y se puede guardar en temporadas ya iniciadas sin alterar su fecha de comienzo.", category: "fix", changes: ["Al crear temporada, la prioridad incluye nombres nuevos y jugadores de la app antes de guardar sus identificadores definitivos.", "Cambiar el reparto en una temporada activa conserva su fecha de inicio histórica; la fecha sigue bloqueada frente a cambios una vez iniciada."] },
  { version: "v1.14.27", date: "16 de septiembre de 2026", title: "Bolas asignadas por la organización", summary: "Las temporadas pueden asignar un custodio de bolas por partido mediante un reparto mínimo y configurable por prioridad.", category: "improvement", changes: ["La creación y configuración de temporada permite activar bolas asignadas por la organización y ordenar prioridades.", "Cada partido muestra su encargado y la compra de bolas desaparece de reservas y pagos cuando la opción está activa.", "La opción queda bloqueada tras registrar el primer resultado de la temporada."] },
  { version: "v1.14.26", date: "16 de septiembre de 2026", title: "Bloque HEAD en posición original", summary: "El bloque vertical de HEAD, Padel Pro y S+ recupera exactamente su posición original.", category: "fix", changes: ["Se elimina cualquier desplazamiento horizontal del grupo."] },
  ...
  { version: "v1.14.9", date: "16 de septiembre de 2026", title: "Validación de acceso a Mis ligas", summary: "La fila funcional de HOME queda alineada con el acceso directo a Mis ligas.", category: "fix", changes: ["Los contratos de validación y tipografía reflejan el nuevo destino del control superior izquierdo."] },
  { version: "v1.14.8", date: "16 de septiembre de 2026", title: "Acceso directo a Mis ligas", summary: "El control superior izquierdo de HOME abre directamente la pantalla Mis ligas para cambiar de competición.", category: "improvement", changes: ["El antiguo botón Refrescar pasa a llamarse MIS LIGAS y conserva la posición compacta de la cabecera.", "Mis partidos sigue disponible como área personal independiente desde la navegación correspondiente."] },
  { version: "v1.14.7", date: "16 de septiembre de 2026", title: "Textos de rendimiento traducidos", summary: "La optimización de acceso conserva la experiencia completa en castellano, inglés y euskera.", category: "fix", changes: ["Los mensajes de la plancha de pegatinas y su impresión ya están cubiertos en todos los idiomas."] },
  { version: "v1.14.6", date: "16 de septiembre de 2026", title: "Snapshot de acceso más rápido", summary: "La comprobación de permisos prepara en paralelo los datos necesarios para reducir la espera de entrada.", category: "improvement", changes: ["La configuración de temporadas se consulta al mismo tiempo que ligas, partidos y jugadores, eliminando una espera secuencial.", "La generación de calendarios conserva su comportamiento fiable y no se ejecuta en paralelo con operaciones dependientes."] },
  { version: "v1.14.5", date: "16 de septiembre de 2026", title: "Inicio más ágil con sesión conocida", summary: "La aplicación muestra antes la última liga disponible mientras actualiza sus permisos y datos en segundo plano.", category: "improvement", changes: ["El estado local validado permite entrar antes al shell de la aplicación sin esperar a que termine toda la revalidación remota.", "Las operaciones protegidas siguen comprobando la sesión y los permisos en el servidor."] },
  { version: "v1.14.4", date: "15 de septiembre de 2026", title: "Pegatinas de logo configurables", summary: "Welcome Pack incorpora una plancha exclusiva de pegatinas del logo con ancho configurable y orientación A4 calculada.", category: "new", changes: ["La nueva opción genera como mínimo una pegatina por jugador y calcula automáticamente el alto proporcional.", "La orientación vertical u horizontal se elige según el ancho y el aprovechamiento de la hoja.", "Los huecos libres se completan con copias del logo de 50 mm de ancho."] },
  { version: "v1.14.3", date: "15 de septiembre de 2026", title: "Ajuste de nombre y logos de prueba", summary: "El nombre de liga se adapta para mostrarse completo y los huecos de la última hoja se aprovechan para probar la impresión del logo.", category: "improvement", changes: ["El nombre de liga reduce su tamaño automáticamente si necesita más espacio, sin superar el tamaño máximo del diseño.", "Los huecos de la última hoja de precintos incluyen el logo de liga a 50 mm de ancho, manteniendo su proporción."] },
  { version: "v1.14.2", date: "15 de septiembre de 2026", title: "Precinto de bolsa más visible", summary: "El contenido del precinto de bolsa gana tamaño para mejorar su lectura en la impresión física.", category: "improvement", changes: ["El logo, título, nombre de liga, jugador y temporada se amplían manteniendo las proporciones del diseño.", "La firma de Smash & Lob conserva su escala discreta."] },
  { version: "v1.14.1", date: "15 de septiembre de 2026", title: "Precintos preparados para corte continuo", summary: "Los PDF del Welcome Pack colocan los diseños juntos para facilitar el corte y extienden el fondo del precinto hasta el sangrado.", category: "improvement", changes: ["Los seis precintos de bolsa se imprimen sin huecos entre diseños para permitir cortes rectos continuos.", "Los dos precintos de bolas incluidos con la faja del bote quedan juntos, sin separación entre sus piezas.", "El sangrado del precinto de bolsa continúa el fondo del diseño en lugar de dejar un recuadro negro independiente."] },
  { version: "v1.14.0", date: "15 de septiembre de 2026", title: "Welcome Pack más legible al imprimir", summary: "El precinto de bolsa amplía su contenido principal para que logo, nombres y datos de liga se aprecien mejor en la impresión física.", category: "improvement", changes: ["El logotipo, nombre de liga, nombre de jugador, regla y temporada del precinto de bolsa aumentan de tamaño manteniendo el acabado y las proporciones del diseño.", "La firma de Smash & Lob conserva su escala discreta dentro de la pieza."] },
  { version: "v1.13.8", date: "27 de agosto de 2026", title: "Sello azul premium reforzado", summary: "La carta mantiene el papel premium y el sello orgánico, pero refuerza el azul del sello para que el logo gane presencia y legibilidad.", category: "improvement", changes: ["El sello limpio y el sello tinta usan un azul más vivo y una conversión más rica para que el logotipo se lea mejor y conserve más personalidad visual.", "Se conservan la textura de papel premium, el tamaño grande del sello, su colocación orgánica y el solape natural con la firma.", "El cierre de la carta y el resto de mejoras de la serie 1.13 se mantienen sin cambios."] },
  { version: "v1.13.6", date: "27 de agosto de 2026", title: "Refuerzo visual de sello y papel", summary: "La carta gana una textura de papel más visible y un sello con más presencia, sin perder el acabado institucional.", category: "improvement", changes: ["La textura del papel premium se refuerza para que el grano y el cuerpo del soporte se aprecien mejor en la carta final.", "El sello limpio y el sello tinta recuperan presencia visual con un azul tinta más vivo, mayor legibilidad del logotipo y un contraste más equilibrado.", "Se mantiene la colocación orgánica del sello, su tamaño grande y el solape natural con la firma, sin reescalados automáticos."] },
{ version: "v1.13.5", date: "27 de agosto de 2026", title: "Acabado premium de carta y sello", summary: "La carta gana textura de papel de buen gramaje, un sello más elegante y un cierre final más limpio.", category: "improvement", changes: ["La carta incorpora una textura sutil de papel premium que aporta grano y fibra sin reducir la legibilidad.", "Sello limpio y Sello tinta usan tonos azul grisáceos menos intensos, menor opacidad y un tratamiento que conserva mejor los detalles del logotipo.", "Se mantiene el sello grande y orgánico de v1.13.4, con posición e inclinación aleatorias controladas y sin redimensionar nunca la firma.", "La última línea de bienvenida deja de repetir el nombre del destinatario; el nombre se conserva en el saludo inicial."] },
  {
    version: "v1.13.4",
    date: "27 de agosto de 2026",
    title: "Sello orgánico y firma sin restricciones",
    summary:
      "La carta gana un sello más grande y físicamente irregular, mientras la firma conserva siempre el tamaño seleccionado incluso cuando ambos elementos se solapan.",
    category: "improvement",
    changes: [
      "El sello institucional aumenta de tamaño para tener más presencia en el cierre de la carta.",
      "Cada render aplica al sello un desplazamiento horizontal y vertical aleatorio controlado y una inclinación de hasta ±9°, evitando el aspecto perfectamente alineado de una composición digital.",
      "La firma deja de reducirse para hacer sitio al sello: conserva siempre el tamaño de la tipografía elegida y se permite el solape parcial como parte del acabado de carta sellada.",
      "La aleatoriedad queda limitada a una zona segura junto a la firma para mantener el sello dentro de la pieza y separado del pie principal del Media Kit.",
    ],
  }, {
    version: "v1.13.3",
    date: "27 de agosto de 2026",
    title: "Carta personalizada por destinatario",
    summary:
      "La carta de bienvenida se personaliza por nombre y género, mantiene el logo original en cabecera y convierte el sello en un remate opcional junto a la firma.",
    category: "improvement",
    changes: [
      "Personalizar incorpora Nombre y Género; el texto automático usa Bienvenido o Bienvenida según corresponda e integra el nombre del destinatario en el saludo y el cierre.",
      "El logo de la liga permanece siempre sin tratamiento en la esquina superior izquierda cuando existe, preservando la identidad original de la competición.",
      "El sello se mueve al bloque de firma y ofrece Sin sello, Sello limpio y Sello tinta; las variantes de sello usan el logo de la liga y no sustituyen la cabecera.",
      "La firma automática pasa a Organización de {nombre de la liga} y sigue siendo editable, igual que la despedida y el cuerpo de la carta.",
      "Cambiar nombre o género regenera los campos automáticos de la carta para mantener coherencia sin obligar a editar manualmente las fórmulas de tratamiento.",
    ],
  },
  {
    version: "v1.13.2",
    date: "27 de agosto de 2026",
    title: "Sello institucional y firma manuscrita",
    summary:
      "La carta de bienvenida gana tratamiento de sello azul tinta, firmas caligráficas premium y una separación más clara de sus bloques institucionales.",
    category: "improvement",
    changes: [
      "El logo de la liga puede mantenerse original o convertirse en Sello limpio o Sello tinta, con tratamiento azul tinta y acabado institucional.",
      "La firma se independiza de la tipografía del cuerpo y ofrece Firma clásica, Allura, Petit Formal Script y Great Vibes; Allura queda como propuesta inicial.",
      "El texto automático introduce bloques separados antes de Desde este momento… y del cierre Bienvenido/a a Smash & Lob, evitando que ambos queden pegados al párrafo anterior.",
      "Las nuevas fuentes manuscritas se cargan bajo demanda desde Google Fonts y conservan un fallback local seguro para la exportación sin conexión.",
    ],
  },
  {
    version: "v1.13.1",
    date: "27 de agosto de 2026",
    title: "Párrafos y tipografía premium en la carta",
    summary:
      "La carta de bienvenida separa correctamente sus bloques y permite elegir entre cuatro estilos editoriales premium con fallback seguro.",
    category: "improvement",
    changes: [
      "Los párrafos automáticos dejan una línea completa de separación y los saltos manuales del editor se respetan también en la imagen exportada.",
      "La carta incorpora cuatro estilos tipográficos: Club clásico (Cormorant Garamond + Libre Baskerville), Editorial premium (Instrument Serif + Lora), Baskerville y Lora.",
      "Las tipografías se cargan como fuentes web de Google Fonts únicamente al componer la carta; si no están disponibles, el render mantiene una pila serif segura para no bloquear la exportación.",
      "El cálculo de altura incluye los huecos de párrafo y conserva la reducción automática del cuerpo para evitar recortes en cartas con bloques contextuales.",
    ],
  },
{ version: "v1.13.0", date: "26 de agosto de 2026", title: "Carta institucional de bienvenida", summary: "El Media Kit incorpora una carta premium editable que adapta automáticamente su contenido a las características reales de cada temporada.", category: "new", changes: ["Nuevo preset Carta de bienvenida con diseño claro tipo papel institucional, cabecera de liga y temporada, texto editorial y firma formal.", "El texto inicial explica de forma breve el acceso por invitación, el perfil de jugador, la gestión desde la app y el Formato Smash & Lob con clasificación individual y rotación de compañeros y rivales.", "Inscripción, Jornada de Apertura, inicio programado y descansos se añaden únicamente cuando existen realmente en la temporada seleccionada; nunca se mencionan como posibilidades genéricas.", "Título, cuerpo completo, despedida y firma son editables, con una acción para restaurar en cualquier momento el texto automático generado desde los datos de la temporada.", "El preset funciona con las temporadas del Media Kit, conserva logo y color de acento y está disponible en castellano, euskera e inglés." ] },{ version: "v1.12.4", date: "26 de agosto de 2026", title: "Auditoría personalizada y creación más clara", summary: "Las temporadas con duración personalizada muestran siempre su auditoría completa y REROLL, y la creación separa claramente tipo de calendario, duración y visibilidad.", category: "fix", changes: ["Gestión muestra Equilibrio del calendario para cualquier duración válida entre 1 jornada y el máximo del generador, no solo para una o dos vueltas completas.", "Una temporada personalizada, como 11 jugadores y 13 jornadas, identifica su modalidad como Personalizada y explica punto por punto partidos por jornada, apariciones, descansos, compañeros, rivales, cuartetos, equilibrio de duración y repeticiones.", "Cuando un reparto exacto no es matemáticamente posible, la auditoría muestra el rango realmente conseguido como Optimizado en lugar de describirlo como un reparto incorrecto.", "REROLL queda disponible para calendarios personalizados bajo la misma protección existente: se bloquea en cuanto hay resultados registrados.", "La creación divide la configuración en tres tarjetas numeradas e independientes: Tipo de calendario, Duración y Visibilidad; Calendario equilibrado y Manual se eligen mediante opciones visibles en lugar de un desplegable."] },{ version: "v1.12.3", date: "26 de agosto de 2026", title: "Duración flexible y temporadas ampliables", summary: "El número de jugadores deja de fijar la duración obligatoria: las temporadas pueden usar vueltas completas escalables o un número personalizado de jornadas, y un calendario sin resultados puede ampliarse después.", category: "new", changes: ["La creación separa Duración equilibrada completa y Personalizada: una personalizada admite cualquier número de jornadas dentro del máximo calculado para la plantilla y genera la distribución más equilibrada posible.", "Si la duración elegida coincide con 1×, 2×, 3× o más vueltas completas, Smash & Lob utiliza automáticamente vueltas completas equilibradas; la Temporada larga permite seleccionar el multiplicador hasta el máximo que el generador puede construir sin repetir partidos exactos.", "Las duraciones parciales priorizan igualdad de partidos y descansos, variedad de compañeros y rivales, ausencia de descansos consecutivos y reducción de repeticiones; cuando la igualdad matemática perfecta no se alcanza, la auditoría identifica el resultado como Optimizado en lugar de tratarlo como un calendario roto.", "Mientras no exista ningún resultado registrado, Gestión permite ampliar una temporada ya creada a Doble vuelta o a una Temporada larga superior bajo la misma barrera de seguridad que REROLL.", "La ampliación de una temporada Supabase sustituye el calendario de forma atómica, actualiza jornadas y modalidad y conserva la Jornada de Apertura, eliminando únicamente el estado operativo ligado a los emparejamientos sustituidos."] },{ version: "v1.12.2", date: "26 de agosto de 2026", title: "Auditoría adaptativa del calendario", summary: "El panel de Equilibrio del calendario muestra las comprobaciones que realmente corresponden al tamaño de cada temporada, incluyendo las reglas específicas de descansos.", category: "improvement", changes: ["Las temporadas sin descansos conservan la auditoría clásica de una aparición por jornada y las frecuencias exactas de compañeros y rivales.", "Las plantillas de 9, 10, 11 y demás tamaños con descansos muestran por separado partidos por jornada, máximo una aparición por jugador, descansos por jornada, descansos por jugador y ausencia de descansos consecutivos.", "La auditoría flexible hace visible también la regla de cuartetos: ningún grupo exacto de cuatro jugadores puede repetirse dentro de una misma vuelta.", "Las reglas de compañeros, rivales, primera y segunda vuelta siguen adaptándose al modo de calendario y mantienen el mismo criterio que utiliza el generador para declarar el calendario equilibrado."] },{ version: "v1.12.1", date: "25 de agosto de 2026", title: "Temporadas con descansos equilibrados", summary: "Cualquier plantilla de 8 a 24 jugadores puede crear una temporada: cuando el tamaño no es múltiplo de cuatro, Smash & Lob reparte automáticamente los descansos sin perder el equilibrio del calendario.", category: "new", changes: ["Los tamaños 9, 10, 11, 13, 14, 15, 17, 18, 19, 21, 22 y 23 dejan de estar bloqueados y generan calendarios deterministas con el mismo número de descansos para todos.", "Cada vuelta evita descansos consecutivos, parejas repetidas y cuartetos repetidos; los enfrentamientos contra un mismo rival quedan limitados a tres como máximo y solo el formato de 9 jugadores necesita alcanzar ese máximo.", "Una vuelta con descansos usa tantas jornadas como jugadores; en cada jornada se juegan floor(N/4) partidos y descansan N mod 4 jugadores.", "HOME y Mis partidos muestran DESCANSAS ESTA JORNADA cuando corresponde sin revelar jornadas que todavía estén ocultas por el calendario progresivo.", "La auditoría, creación por API, duplicación y calendario manual entienden ya los tamaños con descansos, manteniendo los múltiplos de cuatro como calendario perfectamente equilibrado sin descansos; la restricción SQL histórica deja de exigir múltiplos de cuatro."] },{ version: "v1.12.0", date: "25 de agosto de 2026", title: "Tamaño flexible de temporada", summary: "La creación de temporadas deja de estar limitada a 8, 12 y 16 jugadores y prepara la base para plantillas con descansos en las siguientes fases de v1.12.", category: "new", changes: ["El selector de tamaño permite recorrer cualquier cantidad entre 8 y 24 jugadores de uno en uno y explica cuándo el formato admite un calendario perfectamente equilibrado.", "v1.12.0 permite crear temporadas de 8, 12, 16, 20 o 24 jugadores; los tamaños intermedios se pueden seleccionar para anticipar la futura experiencia con descansos, pero todavía bloquean la creación.", "La validación de tamaño se comparte entre interfaz, API y duplicación de temporadas para evitar reglas divergentes.", "El generador equilibrado incorpora calendarios verificados de 20 y 24 jugadores, manteniendo una pareja con cada participante y dos enfrentamientos contra cada rival por vuelta."] },{ version: "v1.11.0", date: "24 de agosto de 2026", title: "Calendario progresivo y experiencia de jugador", summary: "Las temporadas pueden revelar jornadas de forma progresiva, separar una Jornada de Apertura y permitir que un administrador viva la liga sin spoilers sin renunciar a sus herramientas.", category: "new", changes: ["El calendario incorpora modo completo o desbloqueo progresivo: las jornadas futuras mantienen ocultos sus emparejamientos hasta cerrar la anterior o alcanzar su fecha oficial de inicio, con revelación manual anticipada para administradores.", "La Jornada de Apertura puede configurarse como evento especial: su fecha y hora programan automáticamente todos los partidos de Jornada 1 y la cadencia regular comienza en Jornada 2 desde la fecha de Inicio de Liga Regular.", "Los administradores disponen por liga de tres experiencias: Administrador, Jugador y Experiencia jugador; los dos modos de jugador respetan los mismos secretos que el resto y el modo híbrido conserva el acceso explícito a Administración.", "Los calendarios equilibrados de temporadas todavía no iniciadas incorporan REROLL para generar una alternativa equilibrada aunque la auditoría actual sea correcta, bloqueándose si existen partidos ya modificados para proteger los datos.", "La protección de secretos se aplica también en servidor y en la lista de chats; el desbloqueo automático usa Europe/Madrid y genera el aviso de Nueva jornada desbloqueada." ] },{ version: "v1.10.29", date: "21 de agosto de 2026", title: "Ajustes accesibles y amistosos coherentes", summary: "Las temporadas programadas dejan de expulsar de Ajustes, Mis partidos refleja el estado temporal real y los amistosos completan sus avisos equivalentes de partido.", category: "fix", changes: ["El bloqueo de temporadas programadas reconoce todas las pantallas del contexto de Ajustes, por lo que Mi disponibilidad, Mis pagos, Actividad y Administración ya no redirigen inesperadamente a HOME.", "HOME simplifica el aviso previo a ¡NOVEDADES! manteniendo el resto del contenido y el contador de emparejamientos.", "MIS PARTIDOS / Historial reutiliza el mismo ciclo temporal que el detalle: un encuentro pasado muestra En juego durante la ventana activa y después Pendiente de resultado en lugar de quedarse en Programado.", "Los amistosos completan la paridad de push aplicable con partidos de liga: programación, chat, resultado, reserva/pagos, recordatorio de próximo partido y recordatorios por resultado pendiente; los avisos respetan las mismas categorías de preferencias configuradas por dispositivo/ligas.", "El job automático deduplica de forma persistente los avisos de próximo amistoso y resultado pendiente para no repetirlos en cada ejecución."] },{ version: "v1.10.28", date: "21 de agosto de 2026", title: "Estados automáticos y amistosos conectados", summary: "El inicio programado y sus avisos pasan a ser realmente automáticos, HOME cambia de fase sin recargar y los amistosos ganan chat inmediato y notificaciones push.", category: "improvement", changes: ["HOME sustituye YA HAY NOVEDADES por HAY NOVEDADES y los cambios temporales de pretemporada refrescan el snapshot en segundo plano sin recargar la página ni enviar al usuario a Mis ligas.", "El job protegido activa automáticamente las temporadas programadas cuando vence su cuenta atrás y genera el aviso de inicio; si la Jornada 1 empieza a la vez, se combina en una sola notificación y se evita el aviso duplicado de jornada.", "El chat de amistosos muestra el mensaje enviado de forma optimista al instante y notifica por push a los demás participantes vinculados, suprimiendo el aviso si el chat ya está abierto.", "Los amistosos incorporan avisos push para alta, reprogramación, cambios de jugadores, resultado, reserva y pagos, reutilizando las suscripciones activas de cada usuario sin notificarse a uno mismo.", "La app deja de solicitar permisos push automáticamente: cuando faltan, HOME muestra de forma espaciada un recordatorio propio con acción explícita para activarlos o revisar el permiso del navegador.", "Buscar ajustes incorpora acceso directo a Fase secreta y sinónimos de pretemporada, emparejamientos, Jornada de apertura y novedades dentro de Inicio programado."] },{ version: "v1.10.27", date: "21 de agosto de 2026", title: "Pretemporada más clara y aviso de novedades", summary: "La apertura previa gana un mensaje pensado para jugadores, avisa automáticamente cuando aparece nueva información y corrige la navegación Volver para no recargar la app.", category: "improvement", changes: ["HOME deja de mostrar cualquier referencia visible a Fase secretos para jugadores y sustituye el cambio de estado por un bloque claro de novedades con Jornada de apertura y el contador DESCUBRIRÁS TODOS LOS EMPAREJAMIENTOS EN.", "La entrada en la fase previa genera automáticamente una notificación de temporada una sola vez por programación: ¡Ya hay novedades! abre HOME para consultar la nueva información disponible sin adelantar emparejamientos.", "El aviso automático reutiliza el job protegido de notificaciones, respeta la configuración de temporada y las preferencias de avisos y se deduplica por fecha de inicio y días de antelación.", "VOLVER deja de depender de navegación nativa del navegador: siempre usa el router interno de Next.js y conserva un destino seguro, evitando recargas completas y bloqueos dentro de Ajustes sin NAVBAR."] },{ version: "v1.10.26", date: "20 de agosto de 2026", title: "Pretemporada con fase de secretos", summary: "Las temporadas programadas pueden abrir una fase previa que comparte la Jornada 1 de forma segura sin revelar los emparejamientos hasta el inicio real.", category: "new", changes: ["El inicio programado puede activar una Fase secretos entre 1 y 90 días antes: los administradores conservan el acceso completo y los jugadores siguen bloqueados fuera de HOME hasta la activación real.", "Si todos los partidos de Jornada 1 comparten fecha en horario de Madrid y la misma ubicación global, Smash & Lob detecta automáticamente una Jornada de apertura aunque existan horarios y pistas diferentes.", "Durante Fase secretos HOME muestra fecha, franja horaria y ubicación global de la apertura, mantiene ocultos nombres, parejas y pistas concretas y permite añadir un único evento seguro de Jornada 1 a Google Calendar.", "La protección se aplica también en servidor: antes de Fase secretos el snapshot oculta emparejamientos y programación, y durante la fase solo expone la programación saneada de Jornada 1; administradores y superadmin mantienen los datos completos.", "Al llegar la hora programada se conserva la activación automática existente y se libera el acceso completo. Antes de ese momento se silencian también las notificaciones y vías laterales específicas de partido para no romper el misterio; las nuevas notificaciones de Bloqueo, Secretos e Inicio se decidirán después."] },{ version: "v1.10.25", date: "20 de agosto de 2026", title: "Exportables más homogéneos", summary: "Calendario, Clasificación y Resumen de jornada adoptan el lenguaje visual más pulido del Resumen final de temporada para unificar la colección de imágenes compartibles.", category: "improvement", changes: ["Calendario y Clasificación de temporada pasan a usar la misma paleta base, cabecera adaptativa, marco exterior y pie de marca del Resumen final de temporada.", "Las cabeceras de exportación ya no dependen de tamaños rígidos: nombre de liga y temporada reducen tamaño y pueden ocupar hasta dos líneas cuando hace falta, evitando cortes tempranos.", "Resumen de jornada se alinea visualmente con el resto de exportables compartibles mediante la misma base cromática, fondo, sombras, separación de secciones y pie de marca, manteniendo intacta su información específica."] },{ version: "v1.10.24", date: "20 de agosto de 2026", title: "Previsualización real de imágenes compartibles", summary: "Compartir temporada y Resumen de jornada muestran ahora una vista previa real de la imagen antes de compartirla o guardarla.", category: "improvement", changes: ["Compartir resumen de temporada se reorganiza como un espacio de trabajo: selector de Calendario, Enfrentamientos, Clasificación y Resumen, una única preview grande de la pieza activa y las acciones de Compartir/Guardar debajo.", "La preview se genera con exactamente el mismo canvas y las mismas opciones de logo y fotos que el PNG final, y se actualiza al cambiar de pieza o de apariencia.", "Resumen de jornada incorpora una preview completa del PNG generado antes de los botones Compartir resumen y Descargar resumen, manteniendo intacto el diseño interno de la imagen para revisarlo después por separado."] },{ version: "v1.10.23", date: "20 de agosto de 2026", title: "Pagos corregibles desde Mis pagos", summary: "Los pagos marcados por error pueden volver a pendiente desde Mis pagos cuando el usuario tiene permiso real para gestionarlos.", category: "fix", changes: ["Los pagos saldados muestran Marcar como pendiente al receptor de la transferencia y, en Liga o Amistosos, también a los administradores/creadores autorizados cuando participan en ese movimiento.", "El deudor mantiene la posibilidad de marcar su propia deuda como pagada, pero no puede deshacer unilateralmente un pago ya saldado si no tiene permiso de gestión.", "Al volver un pago a pendiente se recalculan inmediatamente Debes, Te deben y las listas filtradas de Todos, Liga y Amistosos sin cambios de base de datos."] },{ version: "v1.10.22", date: "20 de agosto de 2026", title: "Navegación coherente en Ajustes", summary: "Las pantallas que cuelgan de Ajustes dejan de recuperar la NAVBAR principal y todas mantienen una salida Volver acorde a su jerarquía.", category: "fix", changes: ["AppShell amplía el contexto de Ajustes a Mi disponibilidad, Mis ligas, Mis pagos, Actividad, Administración, Gestión de la app, Ayuda, Registro de cambios y Avatar Lab, ocultando la NAVBAR inferior de forma centralizada en todas sus hijas.", "Actividad incorpora Volver: regresa a Panel de administrador cuando se abre en scope admin y a Ajustes para el resto de vistas.", "Sobre la app, Privacidad y Condiciones incorporan Volver dentro de su layout público compartido; si se abren desde Ajustes regresan allí y, en acceso directo, conservan HOME como destino seguro.", "Las pantallas que ya tenían Volver conservan su jerarquía existente; al abrir contenido real de Liga o Mis partidos fuera de estas ramas se recupera su navegación normal."] },{ version: "v1.10.21", date: "20 de agosto de 2026", title: "Exportables simétricos y pagos por contexto", summary: "El calendario de enfrentamientos reparte el mismo espacio a ambas parejas y Mis pagos hace que Todos, Liga y Amistosos cambien realmente el contexto mostrado.", category: "fix", changes: ["Calendario de enfrentamientos centra el VS geométricamente y asigna exactamente el mismo ancho útil a Pareja 1 y Pareja 2, evitando que un mismo nombre se corte solo en el lado izquierdo.", "Los nombres del calendario de enfrentamientos reducen ligeramente su tamaño antes de aplicar puntos suspensivos, aprovechando mejor el ancho disponible sin alterar el resto de exportables.", "Mis pagos convierte Todos, Liga y Amistosos en filtros de contexto completos: resumen Debes/Te deben, pagos pendientes y movimientos se recalculan según la pestaña elegida.", "La pestaña Liga muestra selectores de liga y temporada, inicializados con la liga y temporada actuales; el resumen económico se calcula para esa selección y usa la identidad de jugador correspondiente a cada liga."] },{ version: "v1.10.20", date: "20 de agosto de 2026", title: "Pagos personales unificados", summary: "Los amistosos permiten introducir importes desde el primer momento y Mis pagos agrega deudas de ligas y amistosos en una sola vista personal.", category: "improvement", changes: ["Pagos y reservas preselecciona al usuario actual como pagador de pista cuando una reserva empieza vacía, evitando que el importe quede bloqueado; el importe de bolas puede iniciar automáticamente la selección del comprador.", "Mis pagos incorpora un ledger autenticado de cuenta que reúne transferencias de todas las ligas vinculadas y de los amistosos del usuario, con origen, fecha y acceso directo al partido.", "El resumen Debes / Te deben de Mis pagos y Ajustes pasa a ser global para la cuenta, mientras la Economía de la competición continúa limitada a la liga y temporada seleccionadas.", "La lista de pagos permite filtrar Todos, la liga activa o Amistosos y marcar como pagadas transferencias de cualquiera de los dos tipos mediante sus APIs protegidas existentes."] },{ version: "v1.10.19", date: "20 de agosto de 2026", title: "Ubicaciones fieles al programar y editar", summary: "Liga y Amistosos conservan la ubicación realmente seleccionada y recuperan correctamente la pista al volver a editar un partido.", category: "fix", changes: ["La resolución de ubicaciones deja de considerar suficiente una coincidencia de localidad: el ID guardado es prioritario y los fallbacks legacy solo aceptan coincidencias exactas y no ambiguas.", "Los partidos de Liga que comparten localidad con otros clubes mantienen siempre el lugar seleccionado tanto en pantalla como en Cómo llegar.", "Los amistosos conservan por separado el texto visible y el valor estructurado de ubicación; al editar se recuperan la ubicación global y la pista en lugar de degradarse a Lugar + Ubicación de Maps.", "Los amistosos legacy con etiquetas como Localidad - Club · Pista N se reconocen de forma segura y se estructuran automáticamente la próxima vez que se guardan."] },{ version: "v1.10.18", date: "19 de agosto de 2026", title: "Plantillas continuistas, ubicaciones estructuradas y amistosos visibles", summary: "Las temporadas pueden reutilizar jugadores sin fricción, las ubicaciones dejan de duplicarse por pista y Mis partidos ya no pierde amistosos programados.", category: "improvement", changes: ["Las temporadas posteriores con autoregistro preseleccionan a los jugadores de la temporada anterior, permiten desmarcarlos y los inscriben automáticamente; las plazas restantes quedan abiertas y la cuota económica empieza de cero cada temporada.", "La creación de plantilla fija puede buscar usuarios registrados en Smash & Lob por nombre/avatar público y vincularlos directamente como jugadores de la nueva liga, sin reclamación posterior ni exposición de email.", "Los amistosos guardan ubicación global, pista y snapshot histórico por separado; el catálogo global deja de reconstruirse desde textos legacy de partidos y evita duplicados como una ubicación cuyo nombre incluye Pista 1.", "Superadmin puede inspeccionar usos exactos de cada ubicación, abrir partidos, cambiar o quitar la ubicación de partidos futuros y eliminar una ubicación del catálogo aunque tenga histórico, que se conserva.", "Mis partidos muestra todos los amistosos futuros en Próximos y mueve al historial los amistosos scheduled cuya fecha ya pasó; los partidos de Liga nunca aparecen en Próximos.", "Añadir al calendario conserva el aspecto de botón en amistosos y comparte la misma fila visual con Cómo llegar."] },{ version: "v1.10.17", date: "19 de agosto de 2026", title: "Ajustes sin cambio de contexto y NAVBAR personal segura", summary: "Ajustes deja de sacar al usuario de Mis partidos, los chats eliminan el acceso global a Ajustes y la NAVBAR personal respeta la barra de gestos del móvil.", category: "fix", changes: ["La NAVBAR de Mis partidos aplica la misma superficie segura inferior que la NAVBAR de Liga para que el área de gestos del móvil no corte visualmente la navegación.", "AJUSTES se presenta sin NAVBAR inferior de Liga ni de Mis partidos, evitando cambios de contexto accidentales al entrar desde una sección personal.", "El botón flotante de Ajustes conserva la ruta de origen y el botón Volver de Ajustes regresa de forma determinista a esa pantalla; si Ajustes se abre directamente, el fallback es HOME.", "Los chats de Liga y de Amistosos dejan de mostrar el botón global de Ajustes para mantener la cabecera centrada en la conversación y su navegación propia."] },{ version: "v1.10.16", date: "19 de agosto de 2026", title: "Liga completa en Euskera e Inglés", summary: "Se completa la internacionalización de las pantallas de Liga y se pulen el calendario exportable y los controles flotantes de administración.", category: "improvement", changes: ["Se auditan las pantallas y flujos de Liga para reutilizar el i18n existente y cubrir en Español, Euskera e Inglés títulos, botones, estados, formularios, avisos, errores, chats, economía, clasificación, estadísticas, administración, tutoriales y exportables.", "El proveedor i18n incorpora tx para traducir de forma segura textos visibles heredados y dinámicos sin crear un segundo sistema de idiomas.", "La imagen de Calendario de enfrentamientos mantiene el VS en su posición y reduce el espacio central efectivo para ampliar el área disponible para nombres largos.", "Los controles flotantes superiores pasan a un único grupo flexible: cuando desaparece Añadir porque la plantilla está completa, Ayuda/Tutorial ocupa automáticamente el espacio disponible sin dejar un hueco.", "Se añade i18n:check para comprobar paridad de diccionarios, cobertura de textos dinámicos y de feedback/error, ausencia de español hardcodeado en las pantallas de Liga y las regresiones visuales de esta entrega."] },{ version: "v1.10.15", date: "19 de agosto de 2026", title: "Calendario preparado antes del inicio programado", summary: "Las temporadas programadas por autoregistro generan sus emparejamientos en cuanto la plantilla está completa, sin dejar de estar programadas para los jugadores.", category: "fix", changes: ["Una temporada programada con autoregistro prepara automáticamente calendario, jornadas y emparejamientos cuando se completa la plantilla, manteniendo status upcoming.", "El administrador con VISTA ADMIN puede revisar el calendario completo antes de la fecha; los jugadores siguen bloqueados hasta el inicio real.", "Las temporadas programadas que ya existían también se preparan automáticamente al cargar la aplicación, por lo que no es necesario recrearlas ni iniciarlas manualmente.", "Al llegar la fecha programada se reutiliza exactamente el calendario preparado y no se duplican partidos.", "Si la plantilla cambia antes del inicio, el calendario preparado se invalida y se regenerará cuando vuelva a completarse."] },{ version: "v1.10.14", date: "19 de agosto de 2026", title: "VISTA ADMIN vuelve a simular correctamente al jugador", summary: "Desactivar VISTA ADMIN hace que incluso creador, administradores y superusuarios sufran el bloqueo previo de una temporada programada como un jugador normal, sin perder el countdown de HOME.", category: "fix", changes: ["Se separa definitivamente el rol administrativo real del modo visual activo: los permisos existen, pero el bypass del bloqueo programado solo se aplica con VISTA ADMIN activada.", "HOME, calendario, detalle de PARTIDO, CHAT de Liga y selección de datos de temporada usan isLeagueAdmin/canAccessAdmin para decidir el comportamiento visible.", "Con VISTA ADMIN desactivada un creador/admin vuelve a HOME si intenta entrar en rutas bloqueadas y ve exactamente el mismo estado previo al inicio que un jugador normal.", "Con VISTA ADMIN activada el admin conserva el calendario y la temporada navegables, manteniendo a la vez el countdown y los avisos de inicio programado.", "Se añaden regresiones específicas para admin con VISTA ADMIN ON, admin con VISTA ADMIN OFF y jugador normal."] },{ version: "v1.10.13", date: "19 de agosto de 2026", title: "Inicio programado visible también para admins", summary: "Los administradores conservan el acceso completo a una temporada programada sin perder el countdown ni los avisos de inicio programado en HOME.", category: "fix", changes: ["El bypass administrativo de una temporada programada afecta solo al bloqueo de navegación y acceso: HOME sigue reconociendo que la temporada aún tiene un inicio futuro.", "El countdown principal vuelve a mostrarse también al creador, administradores y superusuarios cuando plantilla e inscripción están listas.", "Si todavía falta completar plantilla o cuotas, el panel Próxima temporada y su countdown/estado de espera también permanecen visibles para administradores, manteniendo a la vez el resto de la temporada navegable.", "Los jugadores normales mantienen exactamente el bloqueo previo al inicio y la Jornada 1 no se activa antes de su fecha."] },{ version: "v1.10.12", date: "18 de agosto de 2026", title: "CHAT compartido entre Liga y Amistosos", summary: "Los chats de Liga y de amistosos pasan a reutilizar la misma base visual y de interacción para evitar divergencias futuras.", category: "foundation", changes: ["Liga y Amistosos comparten el mismo frame de chat, cabecera, burbuja de mensaje de texto, recibos de lectura, composer, barra de solo lectura, gestión del viewport móvil y aviso de ventana de escritura tras finalizar.", "Las propuestas de fecha/ubicación, menciones, respuestas y tarjetas de reserva siguen siendo extensiones específicas del chat de Liga, pero se apoyan sobre la misma base común.", "El chat de amistosos conserva sus reglas de 24 horas de escritura y purga del histórico a los 2 meses, y cualquier cambio visual común del chat se aplica desde ahora a ambos tipos de partido.", "La entrega mantiene acumulados los cambios de v1.10.11: bandeja CHATS de amistosos, selector flotante de jugadores, tutoriales persistentes, cuota de inscripción corregida, temporada programada navegable para admins y botón futuro de transparencia en Economía."] },{ version: "v1.10.11", date: "18 de agosto de 2026", title: "Chats de amistosos y temporada programada para admins", summary: "Mis partidos gana una bandeja de chats, los pagos de inscripción se corrigen y una temporada programada queda plenamente navegable para sus administradores.", category: "improvement", changes: ["Mis partidos incorpora CHATS con todas las conversaciones de amistosos del usuario y el chat informa de forma específica cuando su migración todavía no está aplicada en la base de datos.", "Los selectores de jugadores al crear o editar amistosos se abren como paneles flotantes con fondo difuminado, igual que el selector de ubicaciones.", "Los tutoriales automáticos quedan registrados por recorrido y no vuelven a mostrarse por refrescar o actualizar la aplicación; los recorridos nuevos siguen apareciendo una única vez y la ayuda manual permite repetirlos.", "Marcar la propia cuota de inscripción como pagada usa una API dedicada y autorizada para el jugador, sin depender de los permisos administrativos de Ajustes de temporada.", "Para administradores reales, una temporada programada se navega como una temporada iniciada —calendario, jornadas y partidos— sin adelantar artificialmente la jornada activa; los jugadores mantienen el bloqueo previo al inicio.", "Economía de temporada incorpora el acceso visual al futuro informe de transparencia, todavía marcado como Próximamente."] },{ version: "v1.10.10", date: "18 de agosto de 2026", title: "PARTIDO unificado y chat en amistosos", summary: "Liga y Amistoso comparten más componentes del detalle de partido y ambos chats permanecen abiertos 24 horas tras registrar el resultado.", category: "new", changes: ["PARTIDO de Liga y PARTIDO de Mis partidos reutilizan la misma estructura visual, emparejamiento, programación, Pagos y reservas y formulario de resultado; las diferencias quedan reducidas a reglas de negocio reales.", "Los amistosos muestran REVÉS/DRIVE y DIESTRO/ZURDO en la misma posición y durante los mismos estados que Liga, omitiendo únicamente la posición de clasificación porque no existe fuera de competición.", "Los amistosos incorporan chat privado para participantes vinculados, con la misma experiencia visual básica y Realtime; permite mensajes hasta 24 horas después de registrar el resultado y pasa después a solo lectura.", "El chat de Liga deja de cerrarse inmediatamente al registrar el resultado: los mensajes de texto siguen disponibles durante 24 horas, mientras las propuestas de fecha/ubicación se bloquean al finalizar el encuentro.", "Los mensajes y recibos de lectura de chats de amistosos se purgan automáticamente dos meses después del resultado mediante una migración aditiva protegida para service_role."] },{ version: "v1.10.9", date: "18 de agosto de 2026", title: "Reserva completa desde CHAT y saldo por persona", summary: "Confirmar una reserva desde CHAT registra también sus pagadores e importes, y Economía muestra cuánto saldo disponible corresponde a cada jugador.", category: "improvement", changes: ["Confirmar reserva desde CHAT exige indicar quién o quiénes han pagado la pista y el importe abonado por cada pagador antes de programar el partido.", "La confirmación guarda Pagos y reservas en la misma operación y calcula automáticamente las transferencias entre los cuatro participantes, igual que al registrar la reserva desde PARTIDO.", "En Economía de temporada, el panel Disponible sustituye Ingresado − gastado por el saldo disponible dividido entre el número de jugadores y lo muestra como X € POR PERSONA.", "No hay cambios de Supabase ni migraciones nuevas."] },{ version: "v1.10.8", date: "17 de agosto de 2026", title: "Acciones separadas para el resumen de jornada", summary: "Resumen de Jornada permite compartir o descargar directamente el mismo PNG exportable.", category: "improvement", changes: ["La pantalla muestra Compartir resumen y Descargar resumen en paralelo, siguiendo el patrón visual de los exportables de temporada.", "Compartir mantiene Web Share con fallback de descarga y Descargar guarda directamente el PNG de jornada.", "No hay cambios de Supabase ni migraciones."] },{ version: "v1.10.7", date: "17 de agosto de 2026", title: "Resumen de Jornada aún más compacto y visual", summary: "El exportable de jornada gana avatares en resultados, un MVP integrado dentro de los destacados y un alto reactivo sin espacios sobrantes.", category: "improvement", changes: ["Los paneles de Resultados muestran las imágenes de los jugadores, reducen su altura y mantienen fecha, hora y ubicación con el mismo lenguaje visual del calendario exportado.", "El MVP de la jornada deja de ocupar un bloque propio y pasa a mostrarse como una tarjeta más dentro de Lo más destacado, conservando su protagonismo con una presentación más compacta.", "El exportable adapta su alto al contenido real, añade líneas separadoras de sección y elimina la cabecera visual de Jornada completa para dejar solo la información útil.", "Partido más igualado recoloca el marcador y la banda comparativa, mientras el Calendario con resultados sube ligeramente la barra que separa los metadatos del resultado."] },{ version: "v1.10.6", date: "17 de agosto de 2026", title: "Pulido fino del exportable de Resumen de Jornada", summary: "El resumen gráfico de jornada alinea mejor resultados, MVP, destacados y firma con el resto de exportables.", category: "improvement", changes: ["Las tarjetas de Resultados eliminan la etiqueta de estado, muestran la fecha y hora con el mismo lenguaje visual que Calendario con resultados y dejan el marcador principal sin bloque negro.", "El bloque MVP de jornada gana altura y una presentación más cuidada para que el protagonista respire mejor dentro del exportable.", "Lo más destacado recoloca hacia arriba el bloque de parejas y resultado, mantiene el marcador fuera del chip negro y conserva la retícula de dos tarjetas por fila.", "Clasificación tras la jornada se oculta por completo cuando no hay movimientos de posición y la firma Creado con Smash & Lob sube para quedar mejor equilibrada en el cierre de la imagen."] },{ version: "v1.10.5", date: "17 de agosto de 2026", title: "Exportables más claros en temporada y jornada", summary: "Los resúmenes compartibles refinan clasificación, calendario y la composición visual del resumen de jornada.", category: "improvement", changes: ["La imagen de Clasificación de temporada mantiene las esquinas inferiores redondeadas igual que las superiores.", "En Calendario con resultados, cuando la temporada ya está finalizada desaparece la etiqueta FINALIZADO y ese espacio se dedica por completo a fecha y ubicación del partido.", "El Resumen de Jornada coloca los resultados y los destacados en una retícula de dos tarjetas por fila con el lenguaje visual del calendario exportado.", "La Clasificación tras la jornada se reduce para mostrar solo los jugadores cuya posición ha cambiado y, si no hay movimientos, comunica explícitamente que no hubo cambios de posición."] },{ version: "v1.10.4", date: "17 de agosto de 2026", title: "Ámbito personal libre antes del inicio", summary: "Una temporada programada bloquea solo la competición de esa liga; Mis ligas, Mis partidos y las herramientas globales siguen disponibles y quedan mejor explicadas.", category: "fix", changes: ["El bloqueo previo al inicio sigue devolviendo a HOME al intentar abrir rutas competitivas de la liga programada, pero deja libres Mis ligas, Mis partidos y los flujos globales de acceso.", "Ayuda y los tutoriales explican el alcance de una temporada programada, el cambio entre ligas y el comportamiento de VISTA ADMIN.", "Las normas mostradas al aceptar una invitación incluyen el inicio programado cuando corresponde y aclaran que el ámbito personal sigue disponible.", "No hay cambios de Supabase ni migraciones."] },{ version: "v1.10.3", date: "16 de agosto de 2026", title: "Entrada de liga sin pantallas intermedias", summary: "El acceso espera a conocer las ligas reales de la cuenta antes de decidir la primera pantalla.", category: "fix", changes: ["Mientras se resuelven las membresías se muestra la carga de Smash & Lob y deja de aparecer temporalmente ELIGE CÓMO EMPEZAR.", "Con una sola liga se abre directamente su HOME; con dos o más, el primer destino es MIS LIGAS para elegir a cuál entrar.", "ELIGE CÓMO EMPEZAR solo aparece después de confirmar que la cuenta no tiene ninguna liga asociada.", "Los enlaces y códigos de invitación conservan su flujo específico."] },{ version: "v1.10.0", date: "16 de agosto de 2026", title: "Perfiles, temporadas programadas y Centro de Difusión", summary: "Smash & Lob amplía la preparación de ligas con imágenes de perfil, overrides competitivos, inicio programado y piezas promocionales listas para compartir.", category: "new", changes: ["Completar perfil permite subir una imagen propia opcional con el mismo recorte y compresión del perfil global; si no se sube, se mantiene la imagen de Google o el avatar predeterminado.", "El superadmin dispone de un catálogo de todos los jugadores y puede definir una imagen competitiva independiente de la identidad global de la cuenta, con prioridad visual dentro de la liga.", "Las temporadas pueden guardar una fecha y hora futura de inicio, muestran cuenta atrás, permiten inscripciones y preparación previa y bloquean la operativa competitiva hasta la activación automática server-side.", "Centro de Difusión genera PNG 4:5 de Reglas, Inscripciones, Calendario, Inicio de liga y Cuenta atrás usando logo y datos reales de la liga, con Web Share y descarga como fallback.", "La activación programada reutiliza las reglas de plantilla y pagos existentes; si al llegar la fecha faltan requisitos, la temporada permanece pendiente hasta que puedan cumplirse de forma segura." ] },{ version: "v1.9.9", date: "16 de agosto de 2026", title: "Resumen de Jornada compartible", summary: "Cada jornada puede generar y compartir su propio resumen gráfico con resultados, MVP, destacados y clasificación.", category: "new", changes: ["Compartir resumen de jornada genera una imagen PNG de 1080 px con la misma identidad visual de los exportables de temporada y el logo de la liga cuando está disponible.", "La imagen incluye estado y fechas de la jornada, métricas, todos los resultados y sets, el MVP de jornada o los MVPs de partido según la configuración, y los destacados calculados.", "La clasificación se representa en el estado exacto tras la jornada —o provisional si sigue abierta— con posición, movimiento, diferencia de juegos y puntos.", "En dispositivos compatibles se abre el diálogo nativo para compartir el PNG; si Web Share con archivos no está disponible, la imagen se descarga automáticamente.", "La firma Creado con Smash & Lob se mantiene al pie y no se introducen cambios de API, Supabase ni migraciones." ] },{ version: "v1.9.8", date: "16 de agosto de 2026", title: "Pulido de instalación, chat y destacados", summary: "La instalación PWA se reserva a usuarios recurrentes, CHAT compacta y alinea mejor sus elementos y Resumen de Jornada simplifica rachas y parejas.", category: "improvement", changes: ["El aviso de instalar la PWA aparece únicamente en HOME, con sesión autenticada y cuando la cuenta ya tiene una pertenencia a liga guardada.", "El resumen fijado de una reserva en CHAT usa fecha numérica DD/MM/YYYY manteniendo la hora, y los mensajes enviados igualan visualmente la separación de los recibidos sin alterar el margen correcto de estos.", "EN RACHA muestra solo la racha actual; los destacados con resultado colocan los dos jugadores de cada pareja en líneas separadas y eliminan la barra inclinada.", "MatchReservationConfirmation estabiliza approvedLocations y rejectedLocations con useMemo, eliminando los dos warnings react-hooks/exhaustive-deps." ] },{ version: "v1.9.7", date: "16 de agosto de 2026", title: "Destacados simples con jerarquía recuperada", summary: "Nuevo líder, Mayor subida y En racha recuperan su título propio y compactan únicamente el contenido de la comparación en la línea inferior.", category: "fix", changes: ["LO MÁS DESTACADO vuelve a mostrar NUEVO LÍDER, MAYOR SUBIDA y EN RACHA como títulos independientes en la primera línea.", "Debajo, protagonista y comparación directa comparten una única fila: por ejemplo Andoni Fernández · 2.º → 1.º.", "Partido más igualado y Decidido en tie-break mantienen sin cambios su formato detallado de partido.", "No cambia ningún cálculo de destacados, ranking ni resultados; es una corrección exclusivamente visual."] },{ version: "v1.9.6", date: "16 de agosto de 2026", title: "Resumen de jornada más compacto y conectado", summary: "PARTIDO enlaza Jornada X con su resumen y los destacados simples ocupan una sola línea sin perder la comparación que los justifica.", category: "improvement", changes: ["En PARTIDO, el título Jornada X es pulsable y abre directamente Resumen de Jornada X.", "Nuevo líder, En racha y Mayor subida se compactan en una sola fila con su protagonista y la comparación directa correspondiente.", "Partido más igualado y Decidido en tie-break mantienen el formato detallado de dos niveles porque necesitan mostrar parejas, marcador y comparación del encuentro.", "No cambia el cálculo de destacados ni la navegación de amistosos."] },{ version: "v1.9.5", date: "16 de agosto de 2026", title: "Edición de marcadores sin saltos al borrar", summary: "Registrar resultado conserva el avance automático al introducir juegos, pero deja el foco en el casillero actual cuando se borra un valor.", category: "fix", changes: ["Al introducir un valor válido de 0 a 7, el formulario continúa avanzando automáticamente al siguiente casillero como hasta ahora.", "Al borrar un valor con Backspace o Delete, el foco permanece en ese mismo casillero y deja de saltar al campo anterior.", "El contrato de destacados de v1.9.2 usa un partido igualado que no termina en tie-break decisivo, manteniendo separada la nueva regla de v1.9.4."] },{ version: "v1.9.4", date: "16 de agosto de 2026", title: "Partidos decididos en tie-break", summary: "El Resumen de Jornada reconoce como momento destacado los partidos cuyo tercer set termina 7–6 o 6–7.", category: "improvement", changes: ["LO MÁS DESTACADO añade Decidido en tie-break cuando el tercer set de un partido finalizado es exactamente 7–6 o 6–7.", "La tarjeta mantiene parejas y resultado global, y demuestra el momento con la comparación directa del tercer set y la etiqueta Tie-break.", "Un partido marcado como Decidido en tie-break no se repite además como Partido más igualado; ese destacado busca otro encuentro de la jornada cuando existe.", "Los tie-breaks decisivos se conservan entre los momentos relevantes aunque coincidan con cambios de líder o subidas en clasificación."] },{ version: "v1.9.3", date: "16 de agosto de 2026", title: "Destacados con comparación directa", summary: "Lo más destacado demuestra cada dato con una comparación visible en lugar de repetir información genérica del partido.", category: "improvement", changes: ["Partido más igualado conserva el 2–1 global pero compara los juegos totales de ambas parejas —por ejemplo 15 frente a 13— y muestra la diferencia que justifica el destacado.", "Nuevo líder y Mayor subida comparan directamente la posición anterior con la posición tras la jornada.", "Las rachas comparan el número de victorias consecutivas antes y después de la jornada.", "Se elimina Ver partido: la tarjeta completa del destacado sigue siendo pulsable cuando corresponde a un encuentro."] },{ version: "v1.9.2", date: "16 de agosto de 2026", title: "Destacados de jornada más editoriales", summary: "Lo más destacado deja de repetir los paneles completos de RESULTADOS y resume por qué un dato o partido merece atención.", category: "improvement", changes: ["RESULTADOS conserva MatchDetailPairingPanel como representación completa y canónica de cada encuentro.", "Los destacados basados en partidos se convierten en tarjetas editoriales compactas con motivo, explicación, parejas, marcador global, sets y acceso Ver partido.", "Partido más igualado explica la diferencia total de juegos —incluido el caso de empate— en lugar de repetir los nombres de las parejas como titular.", "La sección Lo más destacado mantiene una única jerarquía visual para datos de clasificación, rachas y partidos, evitando duplicar información recién mostrada en RESULTADOS."] },{ version: "v1.9.1", date: "16 de agosto de 2026", title: "Resumen de jornada más coherente", summary: "La ficha de jornada adopta el resultado visual de PARTIDO, corrige estados y jerarquía y deja preparado el acceso al futuro exportable compartible.", category: "improvement", changes: ["El panel de estado coloca correctamente la franja superior de acento y deja Jornada completada / En curso como titular, manteniendo el progreso de partidos solo en las métricas inferiores.", "RESULTADOS reutiliza MatchDetailPairingPanel, el mismo componente visual de PARTIDO, incluyendo parejas, marcador por sets, sustituciones y destacado MVP sin duplicar una presentación propia.", "Los destacados asociados a un partido, como Partido más igualado, reutilizan también el panel visual de PARTIDO en lugar de describir el encuentro en una línea de texto.", "La cabecera usa el estado real de la temporada —En curso, Próxima o Finalizada— y la clasificación elimina la etiqueta JX suelta junto al título.", "Se añade al final el botón Compartir resumen de jornada con el mismo tratamiento primario del resumen de temporada; la generación de la imagen queda para el siguiente desarrollo." ] },{ version: "v1.9.0", date: "16 de agosto de 2026", title: "Resumen de jornada", summary: "CALENDARIO convierte cada jornada en una ficha histórica con resultados, MVP, destacados y clasificación tras esa jornada.", category: "new", changes: ["La cabecera de cada jornada en CALENDARIO es pulsable y abre su Resumen de Jornada sin introducir una ruta paralela al detalle ya existente.", "La nueva pantalla muestra progreso, resultados y estadísticas básicas; mientras la jornada está abierta la clasificación se identifica como provisional y los destacados esperan a la finalización.", "Las temporadas con MVP por votación muestran el MVP de cada partido; Automático y Automático avanzado muestran el MVP de jornada, y las temporadas sin MVP omiten el bloque.", "Al completar la jornada se calculan hasta tres destacados relevantes —cambio de líder, mayor subida, partido más igualado o racha— y una clasificación histórica con movimientos respecto a la jornada anterior.", "El exportable y el botón Compartir resumen quedan expresamente fuera de esta primera iteración." ] },{ version: "v1.8.23", date: "16 de agosto de 2026", title: "Propuestas propias con contenido más ligero", summary: "CHAT conserva el color del emisor en el bocadillo de las propuestas, pero devuelve fechas, ubicaciones, votos y detalles a superficies claras para mejorar la legibilidad.", category: "fix", changes: ["Las propuestas propias mantienen el color dominante del tema únicamente en el contenedor exterior, conservando la diferencia visual frente a las recibidas.", "Las filas interiores de fecha y ubicación vuelven a fondo claro con texto oscuro, botones de voto blancos y badges de acuerdo o descarte con sus colores habituales.", "Los detalles desplegables de votos usan de nuevo la misma paleta clara independientemente de quién envió la propuesta."] },{ version: "v1.8.22", date: "15 de agosto de 2026", title: "Chat más claro y bandeja más limpia", summary: "El chat distingue mejor las propuestas propias, limpia la reserva pendiente tras confirmar y pule la presentación de ubicaciones y conversaciones.", category: "fix", changes: ["El aviso fijado de Pendiente de reserva desaparece en cuanto existe una reserva confirmada, dejando únicamente el resumen fijado de Reserva.", "Las propuestas propias de fecha y ubicación usan el mismo fondo del mensaje propio y las recibidas mantienen fondo blanco.", "En propuestas de ubicación, el nombre queda centrado verticalmente cuando no hay acuerdo; al alcanzar 4/4 sube para dejar sitio a la etiqueta Acuerdo 4/4.", "La pantalla CHATS elimina los chevrons laterales de cada conversación y recupera ese espacio para el contenido."] },{ version: "v1.8.21", date: "15 de agosto de 2026", title: "Reserva pendiente desde acuerdo de fecha", summary: "El acuerdo 4/4 de fecha y hora pasa directamente a Pendiente de reserva, con confirmación fijada en el chat, ubicación flexible, avisos agrupados y votos reversibles.", category: "improvement", changes: ["El detalle de Programación muestra fecha y hora como Jueves · 19 de Febrero de 2026 · 19:00.", "Una fecha y hora aprobadas 4/4 bastan para pasar a Pendiente de reserva; la ubicación deja de bloquear el acuerdo principal.", "CHAT fija un aviso de Pendiente de reserva con las fechas acordadas, ubicaciones aprobadas si existen, ubicaciones descartadas 4/4 y acciones para confirmar la reserva o descartar las fechas acordadas y proponer otras.", "Al confirmar, si existen ubicaciones aprobadas se limita la elección a ellas; si no existe acuerdo de ubicación se ofrecen las ubicaciones configuradas de la liga salvo las descartadas expresamente 4/4.", "La confirmación de reserva notifica el estado Programado y reutiliza el mismo hilo de notificación del chat para evitar acumulación de avisos de coordinación.", "Pulsar de nuevo sobre el mismo ✓ o ✕ retira el voto de una propuesta y recalcula inmediatamente el estado de coordinación."] },{ version: "v1.8.20", date: "15 de agosto de 2026", title: "Perfiles enlazados desde Chat", summary: "Los nombres de jugadores visibles dentro de una conversación abren directamente su perfil sin depender de búsquedas por texto.", category: "improvement", changes: ["El nombre del autor al inicio de cada bloque de mensajes o propuestas enlaza a su perfil usando el playerId real del participante.", "Los nombres del detalle de votos de cada propuesta son pulsables y llevan al perfil correspondiente.", "Las referencias de mensajes respondidos y la barra Responder a enlazan también al perfil cuando el participante puede resolverse con seguridad dentro del chat."] },{ version: "v1.8.19", date: "15 de agosto de 2026", title: "Votos por opción y hora alineada en Chat", summary: "CHAT permite abrir el detalle de cada opción de una propuesta de forma independiente y mantiene siempre la hora y los checks alineados a la derecha de cada mensaje.", category: "improvement", changes: ["Tocar directamente una hora propuesta despliega únicamente quién ha votado a favor, en contra o sigue pendiente para esa opción, sin abrir el detalle del resto de horarios.", "Las propuestas de ubicación ofrecen el mismo detalle individual al tocar el texto de la ubicación; el encabezado general sigue permitiendo desplegar todas las opciones a la vez.", "La hora de los mensajes y los checks de lectura quedan anclados a la esquina inferior derecha de la burbuja, reservando su espacio para compartir línea con textos cortos y mantener la alineación cuando el contenido envuelve."] },{ version: "v1.8.18", date: "15 de agosto de 2026", title: "Conversaciones más limpias y votos transparentes", summary: "CHAT simplifica la geometría de los mensajes, aprovecha mejor cada línea y permite consultar quién ha votado cada opción sin recargar la vista principal.", category: "improvement", changes: ["Los mensajes dejan de usar piquitos: el primer recibido reduce únicamente la esquina superior izquierda y el primer mensaje propio la superior derecha; los siguientes recuperan las cuatro esquinas redondeadas.", "Hora y checks quedan al final del propio texto cuando existe espacio suficiente y solo saltan a una línea nueva cuando el contenido lo necesita.", "El avatar recibido permanece anclado al inicio del bloque consecutivo y los mensajes siguientes conservan su hueco sin repetir la imagen.", "Tocar el encabezado de una propuesta despliega un detalle sutil por opción con quién ha votado a favor, en contra y quién sigue pendiente.", "El botón flotante de Ajustes queda visible por encima de la capa inmersiva de CHAT igual que en el resto de la aplicación."] },{ version: "v1.8.17", date: "15 de agosto de 2026", title: "Temporadas cerradas y chat con respuestas", summary: "Las temporadas finalizadas quedan realmente en solo lectura salvo para superadmin, mientras CHAT gana respuestas por gesto, acuerdos 4/4 visibles y una composición más compacta.", category: "improvement", changes: ["Una temporada finalizada bloquea resultados, programación, reservas, incidencias, sustituciones, votos y ajustes tanto en interfaz como en API; solo superadmin puede saltarse el bloqueo o reabrirla.", "CHAT permite responder a mensajes deslizando el mensaje hacia la derecha y muestra la referencia citada dentro del nuevo mensaje.", "Las propuestas muestran Acuerdo 4/4 en cuanto una opción recibe unanimidad; si solo está acordada fecha o ubicación, el chat indica claramente qué falta antes de confirmar la reserva.", "Las burbujas reducen márgenes y relleno para mostrar más conversación, y la cola del primer mensaje recibido usa ahora la superficie real del tema también en modo oscuro.", "El modo de solo lectura del chat usa una barra inferior con altura equivalente al compositor y CHAT conserva únicamente el botón flotante de Ajustes."] },{ version: "v1.8.16", date: "14 de agosto de 2026", title: "Chats prioritarios, avisos contextuales y tema Colorido", summary: "Chats separa conversaciones activas y próximas, las notificaciones respetan el chat abierto y avisan de hitos de coordinación, y la primera experiencia adopta Colorido Índigo Claro.", category: "improvement", changes: ["CHATS separa Activos —jornada en curso, siguiente y cualquier conversación futura con mensajes— de Próximos; un nuevo mensaje promociona automáticamente el chat a Activos.", "Las notificaciones del chat se omiten en el dispositivo cuando esa conversación está abierta y visible, y se añaden avisos al alcanzar cuatro votos o cambiar el estado de coordinación.", "El tutorial de CHAT mantiene siempre visibles Omitir, Anterior y Siguiente aunque no exista NAVBAR y usa el viewport real con safe areas.", "El acceso al chat desde PARTIDO sigue reservado exclusivamente a los cuatro participantes del encuentro.", "Los usuarios sin preferencia previa estrenan Claro + Colorido + Índigo; las preferencias ya guardadas se conservan."] },{ version: "v1.8.15", date: "14 de agosto de 2026", title: "Chat inmersivo, avisos agrupados y safe areas", summary: "El chat gana agrupado visual tipo mensajería, entrada animada, más espacio útil y notificaciones por conversación; las guías y cabeceras se endurecen para pantallas con notch.", category: "improvement", changes: ["CHAT elimina el panel visual que lo hacía parecer una tarjeta y ocupa todo el ancho entre cabecera y compositor; también desaparece la franja Coordinando sobre el campo de escritura.", "Los mensajes nuevos entran con una animación corta desde arriba y los bloques consecutivos de un remitente anclan su avatar al primer mensaje; solo ese primer bocadillo conserva la esquina de salida hacia el avatar.", "Las notificaciones push de un mismo chat comparten tag por partido, por lo que una conversación mantiene una sola notificación actualizada en lugar de acumular avisos independientes.", "Las guías contextuales se recalculan con VisualViewport y limitan posición y altura para permanecer dentro de la pantalla incluso con teclado o viewport reducido.", "La aplicación incorpora una safe area superior propia con fallback para PWAs instaladas en iPhone con notch cuando WebKit no informa correctamente env(safe-area-inset-top); CHAT usa explícitamente esa protección en su cabecera.", "La respuesta de texto directamente desde una notificación no se activa: la Web Notifications API estándar no ofrece una entrada de texto interoperable; se mantiene como desarrollo separado."] },{ version: "v1.8.14", date: "14 de agosto de 2026", title: "Emparejamiento más simétrico en Partido", summary: "El detalle previo al resultado separa posición y perfil de juego en tres líneas controladas; una vez jugado el partido, el panel vuelve a centrarse únicamente en nombres y marcador.", category: "improvement", changes: ["En partidos sin resultado, el primer jugador de cada pareja muestra posición en liga, perfil de juego y nombre completo, en ese orden.", "El segundo jugador invierte la jerarquía para mantener la simetría: nombre completo, perfil de juego y posición en liga.", "Las líneas de posición y perfil de juego reservan su altura aunque falte algún dato, evitando saltos de composición entre jugadores.", "Cuando el partido ya tiene resultado se ocultan posición en liga y perfil de juego; se mantienen nombres, marcador y los indicadores propios de MVP o sustitución cuando correspondan."] },{ version: "v1.8.13", date: "14 de agosto de 2026", title: "Reserva fijada en el chat", summary: "Cuando la programación queda confirmada, el chat mantiene visible un resumen compacto de la reserva por encima del historial.", category: "improvement", changes: ["CHAT fija sobre el historial una línea compacta con fecha, hora y pista cuando el partido está programado y la reserva está confirmada.", "El resumen se obtiene del estado actual del partido y de la reserva, no del histórico limitado de mensajes, por lo que permanece aunque la conversación crezca y refleja la programación vigente.", "El historial conserva el mensaje original de Partido programado y sigue desplazándose de forma independiente bajo el resumen fijado.", "La guía contextual de Chat explica el nuevo resumen de reserva y sube de versión para que la ayuda actualizada pueda volver a mostrarse."] },{ version: "v1.8.12", date: "14 de agosto de 2026", title: "Bandeja de chats más limpia", summary: "La bandeja compacta mejor la información: reconoce tus propios mensajes, unifica el acento lateral y reserva los estados para cambios relevantes.", category: "improvement", changes: ["La preview del último mensaje muestra Yo cuando el remitente eres tú, en lugar de repetir tu nombre.", "Cada bloque de conversaciones unidas comparte una única barra degradada lateral continua; ya no se reinicia el degradado en cada tarjeta.", "Los estados de partido en Chats usan una pastilla más discreta para no competir con la jornada, participantes ni mensajes sin leer.", "Sin programar deja de mostrarse en Chats; solo aparecen Coordinando, Pendiente de reserva, Programado o Aplazado cuando aportan información, mientras Solo lectura se mantiene en finalizados."] },{ version: "v1.8.11", date: "14 de agosto de 2026", title: "Chat más compacto y propuestas más controlables", summary: "Proponer fecha permite retirar cualquier opción en un toque, el chat mejora su acabado visual y la bandeja gana estados, orden de mensajería y tutoriales propios.", category: "improvement", changes: ["Las fechas seleccionadas se muestran como chips compactos y cualquiera puede retirarse directamente; desaparece la aclaración sobre la próxima hora en punto cuando no hay disponibilidades.", "El icono de enviar conserva su tamaño de 23 px y gira 25 grados a la derecha manteniendo el ajuste óptico hacia la izquierda.", "El scroll de mensajes queda dentro de una envolvente con overflow recortado para respetar visualmente las esquinas redondeadas del panel.", "Chats muestra en conversaciones activas el estado del partido con los mismos tonos de Sin programar, Coordinando, Pendiente de reserva y Programado; Solo lectura sigue reservado a finalizados.", "Las conversaciones con actividad se ordenan por último mensaje; las vacías quedan detrás en orden ascendente de jornada.", "Las tarjetas de cada sección quedan unidas: primera con esquinas superiores, intermedias rectas y última con esquinas inferiores, conservando la barra degradada lateral.", "Se añaden guías contextuales específicas para Chats y para el Chat del partido, explicando no leídos, estados, avatares, lectura, propuestas y respuesta optimista."] },{ version: "v1.8.10", date: "14 de agosto de 2026", title: "Selección directa de fechas en chat", summary: "Proponer fecha elimina la lista intermedia y permite marcar horarios directamente en el calendario; el icono de envío gana presencia sin cambiar el botón.", category: "improvement", changes: ["El calendario de propuesta mantiene hasta 14 días y permite seleccionar o quitar horarios compatibles tocándolos directamente, sin botón Añadir.", "Cada día muestra un contador compacto con el número de horarios seleccionados para conservar contexto al navegar entre fechas.", "Elegir otra hora desde el selector manual la incorpora directamente a la propuesta y permite quitarla desde el mismo control.", "El botón final refleja la acción exacta: Proponer esta fecha o Proponer N fechas, con un máximo de cuatro opciones como en el flujo anterior.", "El SVG de enviar crece aproximadamente un 28 % dentro del mismo botón circular y se desplaza un píxel a la izquierda para mejorar el centrado óptico."] },{ version: "v1.8.9", date: "14 de agosto de 2026", title: "Identidad y lectura en chats", summary: "Los chats de grupo ganan identidad visual por jugador, avatares agrupados, confirmaciones de lectura y un aviso de no leídos más reconocible.", category: "improvement", changes: ["Cada participante usa un color estable en su nombre dentro del chat para identificar rápidamente quién escribe.", "Los mensajes recibidos muestran la imagen de perfil del jugador; en secuencias consecutivas del mismo remitente el avatar aparece una sola vez, al final del grupo.", "Los mensajes y propuestas propios muestran confirmación de envío y doble check azul cuando todos los demás participantes vinculados los han leído.", "La lectura se apoya en match_chat_reads y se sincroniza mediante Realtime sin exponer contenido adicional del chat.", "La pantalla Chats mantiene el contador por conversación en una bolita circular más clara cuando existen mensajes sin leer.", "Se conserva la actualización optimista de v1.8.8 para mensajes, propuestas y votos, sin esperar visualmente a la red."] },{ version: "v1.8.8", date: "14 de agosto de 2026", title: "Chat con respuesta visual instantánea", summary: "Mensajes, propuestas y votos se reflejan al instante mientras la API y Realtime confirman los cambios en segundo plano.", category: "improvement", changes: ["Los mensajes de texto aparecen inmediatamente en la conversación al pulsar enviar, sin esperar al POST ni a una recarga del chat.", "Las propuestas de fecha y ubicación se insertan de forma optimista con el mismo diseño definitivo y el panel se cierra al instante.", "Los votos cambian inmediatamente a check verde o X roja y actualizan el recuento local antes de que termine la petición PATCH.", "Las confirmaciones del servidor y Realtime sincronizan silenciosamente el estado definitivo; si una petición falla, solo se revierte la acción afectada y se restaura el borrador cuando corresponde.", "El compositor deja de bloquear nuevos mensajes mientras un envío anterior sigue pendiente, manteniendo el foco tras enviar texto."] },{ version: "v1.8.7", date: "14 de agosto de 2026", title: "Estado de coordinación inmediato en Partido", summary: "El detalle del partido muestra desde el primer render el estado de coordinación ya disponible en el snapshot global, evitando el salto visual de Sin programar a Coordinando.", category: "fix", changes: ["PARTIDO reutiliza match.coordinationStatus desde el primer render en lugar de esperar a la petición detallada de coordinación.", "La consulta de coordinación continúa en segundo plano para Realtime y para las opciones completas de reserva, pero ya no provoca un estado visual inicial incorrecto.", "Si la consulta detallada aporta un estado más reciente, este prevalece; si todavía no ha llegado, se conserva el estado derivado del snapshot de acceso."] },{ version: "v1.8.6", date: "14 de agosto de 2026", title: "Estados de coordinación en Inicio y Calendario", summary: "Las etiquetas existentes de partido reflejan también la coordinación desde chat sin añadir información adicional a las tarjetas.", category: "improvement", changes: ["HOME y CALENDARIO reutilizan la etiqueta de estado existente para mostrar Coordinando y Pendiente de reserva cuando corresponda.", "Sin programar conserva el tono neutro, Coordinando usa violeta suave, Pendiente de reserva índigo suave, Programado azul y Finalizado negro.", "El snapshot de acceso calcula únicamente el estado derivado de coordinación para los partidos sin programar; no expone propuestas, votos ni contenido del chat.", "Después de proponer o votar desde el chat, el estado derivado se sincroniza también en memoria para que al volver a Inicio o Calendario la etiqueta quede actualizada sin refrescar la app."] },{ version: "v1.8.5", date: "14 de agosto de 2026", title: "Propuestas más claras y estados de programación", summary: "Las propuestas del chat ganan fechas más legibles, votación visual y una jerarquía de estados más clara durante la programación.", category: "improvement", changes: ["Las fechas propuestas muestran el día de la semana tanto antes de enviar como dentro del mensaje del chat.", "Las propuestas de horario y ubicación se votan con botones grandes de aceptar y rechazar; el voto propio queda verde o rojo y mantiene visibles los recuentos.", "El panel de programación sin datos pasa a llamarse Programación manual para diferenciarlo del flujo coordinado desde chat.", "Los estados intermedios del partido ganan colores propios: Coordinando usa violeta suave y Pendiente de reserva índigo suave; Sin programar sigue neutro, Programado azul y Finalizado negro."] },{ version: "v1.8.4", date: "14 de agosto de 2026", title: "Chat sin memoización manual y nuevo icono de envío", summary: "Se corrige la validación del chat con React Compiler y el botón de enviar adopta el icono SVG facilitado.", category: "improvement", changes: ["La pantalla del chat elimina la memoización manual conflictiva al cargar mensajes, evitando el bloqueo de ESLint con React Compiler.", "La carga inicial, la reentrada en primer plano y las actualizaciones Realtime siguen refrescando la conversación y la caché de sesión sin alterar el comportamiento funcional.", "El botón de enviar mensaje en CHAT sustituye el avioncito de papel por el SVG proporcionado como nuevo icono de envío.", "Se mantiene el resto del trabajo de v1.8.3: acceso inmediato al final de la conversación, propuestas visuales de fecha y mejor control del foco y del teclado."] },{ version: "v1.8.3", date: "14 de agosto de 2026", title: "Chat inmediato y propuestas visuales", summary: "El chat entra directamente en los mensajes más recientes y las propuestas de fecha ganan un selector visual de dos semanas guiado por la disponibilidad de los jugadores.", category: "improvement", changes: ["Los chats activos se precargan desde la bandeja sin marcarlos como leídos, y el chat reutiliza una caché de sesión mientras sincroniza silenciosamente con servidor y Realtime.", "La conversación se coloca abajo del todo sin animación de desplazamiento al cargar o recibir la instantánea inicial.", "Proponer fecha muestra un calendario compacto de hasta 14 días con el día de la semana, hora editable y horarios compatibles cuando existe disponibilidad informada.", "La primera fecha y hora propuesta prioriza el próximo hueco compatible entre la disponibilidad configurada de los participantes; si nadie ha informado disponibilidad, usa la próxima hora en punto.", "Abrir y utilizar propuestas deja de forzar el foco del cuadro de mensaje; solo el envío de un mensaje de texto conserva o recupera el foco para seguir escribiendo.", "Las ubicaciones del panel y las propuestas conocidas se muestran como Localidad - Nombre.", "Se corrigen los tipos del flujo de coordinación y restauración de fecha introducidos con la reserva desde chat."] },{ version: "v1.8.2", date: "14 de agosto de 2026", title: "Acuerdos y reserva desde el chat", summary: "Las propuestas del chat pueden culminar en una reserva confirmada que programa el partido con fecha, lugar y pista validados.", category: "improvement", changes: ["Las propuestas admiten hasta cinco horarios y el sistema detecta automáticamente opciones de fecha y ubicación aceptadas 4/4.", "COORDINANDO y PENDIENTE DE RESERVA funcionan como estados visuales de coordinación sin alterar el estado competitivo interno del partido.", "Confirmar reserva solo permite elegir fechas y ubicaciones aprobadas por los cuatro jugadores y obliga a escoger una pista configurada del lugar seleccionado.", "Confirmar la reserva marca la pista como reservada, programa el partido y publica en el chat un mensaje de sistema con Añadir al calendario.", "El detalle del partido conserva su diseño: solo cambia el badge de estado y añade Confirmar reserva dentro del panel de programación existente cuando procede.", "La reserva de pista queda separada de los pagos: puede estar confirmada aunque todavía no se haya indicado quién pagó, y los participantes pueden completar esos importes después."] },{ version: "v1.8.1", date: "13 de agosto de 2026", title: "Chats en tiempo real", summary: "Los chats abiertos, la bandeja y el contador de no leídos reaccionan al instante mediante Supabase Realtime sin exponer las tablas privadas.", category: "improvement", changes: ["Los mensajes y las respuestas a propuestas aparecen en los chats abiertos mediante Supabase Realtime, eliminando el sondeo periódico.", "La pantalla Chats actualiza último mensaje, orden y no leídos al recibir actividad, y la NAVBAR actualiza su badge sin esperar intervalos.", "Cambios de programación, resultado o resolución de incidencias refrescan la conversación y mantienen los chats activos por encima de los finalizados sin separar los activos en una sección propia.", "La bandeja identifica los participantes solo por su nombre de pila para compactar cada jornada.", "Realtime usa Broadcast con tópicos HMAC opacos y payloads de invalidación sin contenido del chat; los datos siguen leyéndose exclusivamente por las APIs autenticadas existentes.", "El chat de partido mantiene el compositor preparado al enviar o usar propuestas, sustituye el botón + por un clip, muestra completos los nombres de ubicaciones y convierte el título del chat en acceso directo al detalle del partido.", "El panel superior de jugadores del chat queda oculto por defecto para ganar espacio con el teclado móvil, pero se conserva en código para poder reactivarlo."] },{ version: "v1.8.0", date: "12 de agosto de 2026", title: "Chats como módulo y pulido transversal", summary: "El chat gana bandeja propia, no leídos y avisos push, mientras perfiles, ubicaciones, fechas y nombres ganan consistencia.", category: "new", changes: ["Nueva pantalla Chats en la NAVBAR para jugadores vinculados, con conversaciones por partido, último mensaje y contador de no leídos.", "Los mensajes pueden generar push configurable para los demás participantes y abren directamente la conversación; el emisor no recibe su propio aviso.", "Los chats de partidos con resultado pasan automáticamente a modo lectura, protegido también en servidor.", "El perfil global exige posición preferida y mano dominante, mostrándolas como REVÉS DIESTRO o DRIVE ZURDO en Perfil y junto a la posición de liga en PARTIDO; disponibilidad y recomendaciones pasan a ser opcionales por temporada.", "Los nombres largos permanecen en una línea con elipsis y todas las fechas visibles incluyen el año.", "Añadir nueva ubicación queda fijo fuera del scroll y al activarlo se muestra solo el formulario de alta.", "El tutorial del detalle de partido señala el acceso directo al chat."] },{ version: "v1.7.0", date: "12 de agosto de 2026", title: "Chat privado por partido", summary: "Los cuatro jugadores de un encuentro pueden coordinarse en un chat privado con una experiencia móvil de mensajería.", category: "new", changes: ["Chat accesible desde el detalle del partido únicamente para sus jugadores.", "Mensajes de hasta 2.000 caracteres, actualización automática y protección frente a envíos masivos.", "La base conserva la temporada actual y las dos anteriores; los chats más antiguos se purgan al cerrar temporadas."] },
