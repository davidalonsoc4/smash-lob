...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.23", date: "16 de septiembre de 2026", title: "Tamaño de nombres sin controles extra", summary: "La faja del bote vuelve a usar el tamaño fijo del diseño y retira los controles experimentales de escala.", category: "fix", changes: ["Se eliminan los botones +, −, aplicar y restablecer del bloque de jugadores."] },
