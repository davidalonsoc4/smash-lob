...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.22", date: "16 de septiembre de 2026", title: "Aplicar cambios de la faja", summary: "La faja del bote incorpora un botón para regenerar explícitamente la composición después de ajustar los nombres.", category: "fix", changes: ["Aplicar cambios remonta la preview y garantiza que el PDF use los valores seleccionados."] },
