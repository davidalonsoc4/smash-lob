...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.25", date: "16 de septiembre de 2026", title: "Ajuste fino del bloque HEAD", summary: "El bloque vertical de HEAD, Padel Pro y S+ queda con un desplazamiento neto de 1 mm a la derecha.", category: "fix", changes: ["El grupo completo se mueve 1 mm a la izquierda respecto al ajuste anterior."] },
