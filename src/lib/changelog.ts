...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.16", date: "16 de septiembre de 2026", title: "Tipografías modernas para nombres", summary: "El selector de nombres del Welcome Pack incorpora ocho tipografías modernas, sobrias y legibles.", category: "new", changes: ["Se añaden Montserrat, Oswald, Bebas Neue, Space Grotesk, DM Sans, Manrope, Plus Jakarta Sans y Archivo.", "Las tipografías manuscritas existentes siguen disponibles para conservar los diseños ya probados."] },
