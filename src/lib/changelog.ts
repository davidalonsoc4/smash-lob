...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.24", date: "16 de septiembre de 2026", title: "Ajuste del bloque HEAD", summary: "El bloque vertical de HEAD, Padel Pro y S+ se desplaza 2 mm a la derecha sin alterar su composición.", category: "fix", changes: ["Solo se modifica la posición horizontal del grupo completo; tamaños, rotación y separaciones se mantienen."] },
