...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.20", date: "16 de septiembre de 2026", title: "Tamaño de nombre ajustable en la faja", summary: "La faja del bote permite ampliar o reducir el tamaño de los nombres del listado y restablecerlo al valor de diseño.", category: "improvement", changes: ["Los controles más, menos y restablecer se aplican a la preview y a la plancha PDF; el valor inicial conserva el tamaño actual."] },
