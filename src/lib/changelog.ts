...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.19", date: "16 de septiembre de 2026", title: "Mayúsculas también en la faja del bote", summary: "El formato original o en mayúsculas se puede controlar también en la lista de jugadores de la faja del bote de pelotas.", category: "improvement", changes: ["El selector de formato se comparte con el precinto de bolsa y actualiza la lista de jugadores de ambas previews."] },
