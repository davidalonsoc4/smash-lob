...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  { version: "v1.14.18", date: "16 de septiembre de 2026", title: "Formato y tipografía de nombres", summary: "El Welcome Pack permite conservar los nombres como vienen o convertirlos a mayúsculas y añade la fuente base Arial/Helvetica al selector.", category: "improvement", changes: ["El formato elegido se refleja en la preview del precinto de bolsa y en todos los nombres del PDF generado.", "Arial/Helvetica queda disponible como opción explícita junto a las tipografías modernas."] },
