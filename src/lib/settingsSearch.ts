...
const entryCopyByLocale: Record<Locale, Record<string, EntryCopy>> = {
  es: {
    ...
    appearance: { title: "Apariencia", description: "Elige modo claro, oscuro, sistema o colorido.", section: "preferences", keywords: ["tema", "modo oscuro", "dark", "claro", "sistema", "colorido", "colores", "diseño"] },
  ...
  en: {
    ...
    appearance: { title: "Appearance", description: "Choose light, dark, system or colorful mode.", section: "preferences", keywords: ["theme", "dark mode", "light", "system", "colorful", "colors", "design"] },
  ...
  eu: {
    ...
    appearance: { title: "Itxura", description: "Aukeratu modu argia, iluna, sistema edo koloretsua.", section: "preferences", keywords: ["gaia", "modu iluna", "argia", "sistema", "koloretsua", "koloreak", "diseinua"] },
