...
const entryCopyByLocale: Record<Locale, Record<string, EntryCopy>> = {
  es: {
    ...
    appearance: { title: "Temas y apariencia", description: "Combina tema claro, oscuro o del sistema con estilo Plano o Colorido.", section: "preferences", keywords: ["tema", "modo oscuro", "dark", "claro", "sistema", "plano", "colorido", "estilo", "colores", "diseño", "paleta", "índigo", "violeta", "azul noche", "celeste", "salvia", "bosque", "borgoña", "rosa empolvado", "arena", "terracota", "grafito", "azul hielo"] },
  ...
  en: {
    ...
    appearance: { title: "Themes and appearance", description: "Combine a light, dark or system theme with Plain or Colorful styling.", section: "preferences", keywords: ["theme", "dark mode", "light", "system", "plain", "flat", "colorful", "style", "colors", "design", "palette", "indigo", "violet", "midnight blue", "sky blue", "sage", "forest", "burgundy", "dusty pink", "sand", "terracotta", "graphite", "ice blue"] },
