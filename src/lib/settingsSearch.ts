...
const entryCopyByLocale: Record<Locale, Record<string, EntryCopy>> = {
  es: {
    ...
    appearance: { title: "Temas y apariencia", description: "Combina tema claro, oscuro o del sistema con estilo Clásico o Colorido.", section: "preferences", keywords: ["tema", "modo oscuro", "dark", "claro", "sistema", "clásico", "clasico", "plano", "colorido", "estilo", "colores", "diseño", "paleta", "índigo", "violeta", "azul noche", "celeste", "salvia", "bosque", "borgoña", "rosa empolvado", "arena", "terracota", "grafito", "azul hielo"] },
    ...
    privacy: { title: "Política de privacidad", description: "Consulta qué datos se utilizan y cómo ejercer tus derechos.", section: "help", keywords: ["privacidad", "datos", "rgpd", "protección de datos", "google", "derechos"] },
    terms: { title: "Condiciones de uso", description: "Consulta las normas y responsabilidades de uso de la aplicación.", section: "help", keywords: ["condiciones", "términos", "legal", "normas", "responsabilidad"] },
    ...
    adminView: { title: "Modo de experiencia", description: "Cambia entre Administrador, Jugador y Experiencia jugador sin alterar tus permisos reales.", section: "preferences", keywords: ["administrador", "modo jugador", "experiencia jugador", "vista jugador", "vista admin", "vista administrador", "simular jugador", "permisos admin"] },
    ...
    leagueIdentity: { title: "Identidad de la liga", description: "Edita nombre, descripción, logotipo y recomendaciones.", section: "league", keywords: ["logo", "nombre", "descripción", "imagen", "cambiar nombre liga", "editar liga", "logotipo liga", "recomendaciones"] },
    leagueRecommendations: { title: "Recomendaciones de la liga", description: "Edita las bolas, pistas, equipamiento y consejos recomendados para los jugadores.", section: "league", keywords: ["recomendación", "recomendaciones", "bolas", "pelotas", "pistas", "clubes", "equipamiento", "material", "consejos", "guía liga"] },
    ...
    scheduledStart: { title: "Inicio programado", description: "Programa, cambia o desactiva la fecha y hora de inicio de una temporada pendiente.", section: "season", keywords: ["inicio programado", "temporada programada", "fecha de inicio", "hora de inicio", "programar inicio", "cuenta atrás", "cuenta atras", "countdown"] },
    preseasonSecrets: { title: "Fase secreta", description: "Configura cuándo se publica la información segura de la Jornada 1 antes de comenzar la temporada.", section: "season", keywords: ["fase secreta", "fase secretos", "secretos", "pretemporada", "emparejamientos", "novedades", "inicio programado"] },
    openingRound: { title: "Jornada de Apertura", description: "Configura fecha, hora y ubicación común de la Jornada 1 especial.", section: "season", keywords: ["jornada de apertura", "apertura", "fecha apertura", "hora apertura", "ubicación apertura", "lugar apertura", "jornada 1"] },
    organizationBalls: { title: "Bolas asignadas por la organización", description: "Elige el orden de prioridad o selecciona qué jugadores pueden ser custodios y consulta quién lleva las bolas en cada partido.", section: "season", keywords: ["bolas asignadas", "bolas de la organización", "bolas organizacion", "botes asignados", "reparto de botes", "custodio de bolas", "custodios", "seleccionar custodios", "encargado de las bolas"] },
    calendarVisibility: { title: "Visibilidad del calendario", description: "Elige calendario completo o desbloqueo progresivo de emparejamientos.", section: "season", keywords: ["calendario progresivo", "desbloqueo progresivo", "emparejamientos secretos", "secretos", "revelar jornada", "visibilidad"] },
    rerollCalendar: { title: "REROLL del calendario", description: "Genera otro calendario equilibrado antes de iniciar la temporada.", section: "season", keywords: ["reroll", "regenerar calendario", "otro calendario", "calendario nuevo", "spoiler", "equilibrado"] },
    ...
    registration: { title: "Inscripción", description: "Activa, desactiva y modifica la cuota de una temporada pendiente.", section: "season", keywords: ["cuota", "pago", "importe", "dinero", "activar inscripción", "desactivar inscripción", "sin inscripción", "cuota temporada", "precio inscripción", "concepto inscripción"] },
    seasonFinances: { title: "Economía de temporada", description: "Consulta lo cobrado por inscripciones, registra gastos y controla el saldo disponible.", section: "admin", keywords: ["gastos temporada", "gastos", "dinero inscripción", "saldo", "caja", "cuentas", "ingresos", "dinero restante", "economía", "contabilidad"] },
    ...
    mediaKit: { title: "Centro de difusión", description: "Genera imágenes de reglas, inscripciones, calendario, inicio y cuenta atrás para compartir.", section: "admin", keywords: ["centro de difusión", "centro de difusion", "media kit", "compartir imagen", "reglas", "inscripciones", "calendario", "imagen cuenta atrás", "imagen cuenta atras", "pieza cuenta atrás"] },
    ...
    applicationAdmin: { title: "Gestión de la app", description: "Administra usuarios, ubicaciones y controles globales.", section: "admin", keywords: ["superusuario", "usuarios globales", "ubicaciones", "lugares", "aplicación"] },
    competitivePlayerImages: { title: "Imágenes competitivas de jugadores", description: "Gestiona la imagen competitiva que prevalece en las ligas sin modificar la imagen global de la cuenta.", section: "admin", keywords: ["imagen competitiva", "foto competitiva", "foto jugador", "imagen jugador", "avatar competitivo", "override imagen", "usar global"] },
  ...
  en: {
    ...
    appearance: { title: "Themes and appearance", description: "Combine a light, dark or system theme with Classic or Colorful styling.", section: "preferences", keywords: ["theme", "dark mode", "light", "system", "classic", "plain", "flat", "colorful", "style", "colors", "design", "palette", "indigo", "violet", "midnight blue", "sky blue", "sage", "forest", "burgundy", "dusty pink", "sand", "terracotta", "graphite", "ice blue"] },
    ...
    privacy: { title: "Privacy policy", description: "Review what data is used and how to exercise your rights.", section: "help", keywords: ["privacy", "data", "gdpr", "data protection", "google", "rights"] },
    terms: { title: "Terms of use", description: "Review the rules and responsibilities for using the application.", section: "help", keywords: ["terms", "legal", "rules", "responsibility", "conditions"] },
    ...
    adminView: { title: "Experience mode", description: "Switch between Administrator, Player and Player experience without changing your real permissions.", section: "preferences", keywords: ["administrator", "admin view", "player mode", "player experience", "simulate player", "admin permissions"] },
    ...
    leagueIdentity: { title: "League identity", description: "Edit name, description, logo and recommendations.", section: "league", keywords: ["logo", "name", "description", "image", "change league name", "edit league", "league logo", "recommendations"] },
    leagueRecommendations: { title: "League recommendations", description: "Edit the balls, courts, equipment and practical advice recommended for players.", section: "league", keywords: ["recommendation", "recommendations", "balls", "courts", "clubs", "equipment", "gear", "advice", "league guide"] },
    ...
    scheduledStart: { title: "Scheduled start", description: "Schedule, change or disable the start date and time of a pending season.", section: "season", keywords: ["scheduled start", "scheduled season", "start date", "start time", "schedule start", "countdown"] },
    preseasonSecrets: { title: "Secret phase", description: "Choose when safe Round 1 information becomes visible before the season starts.", section: "season", keywords: ["secret phase", "preseason", "pairings", "updates", "scheduled start"] },
    openingRound: { title: "Opening Round", description: "Set the shared date, time and location for the special Round 1 event.", section: "season", keywords: ["opening round", "opening day", "opening date", "opening time", "opening location", "round 1"] },
    organizationBalls: { title: "Organisation-assigned balls", description: "Set custodian priority or choose eligible players and see who brings balls to each match.", section: "season", keywords: ["organization-assigned balls", "organisation-assigned balls", "ball allocation", "ball distribution", "ball custodian", "custodian priority", "select custodians", "who brings balls"] },
    calendarVisibility: { title: "Calendar visibility", description: "Choose a full calendar or progressive pairing reveals.", section: "season", keywords: ["progressive calendar", "progressive reveal", "secret pairings", "reveal round", "visibility"] },
    rerollCalendar: { title: "Calendar REROLL", description: "Generate another balanced calendar before the season starts.", section: "season", keywords: ["reroll", "regenerate calendar", "new calendar", "spoiler", "balanced"] },
    ...
    registration: { title: "Registration fee", description: "Enable, disable and edit the fee for a pending season.", section: "season", keywords: ["fee", "payment", "amount", "money", "enable registration", "disable registration", "no registration fee", "season fee", "registration price", "registration purpose"] },
    seasonFinances: { title: "Season finances", description: "Review registration income, record expenses and track the available balance.", section: "admin", keywords: ["season expenses", "expenses", "registration money", "balance", "cash", "accounts", "income", "money left", "finances", "accounting"] },
    ...
    mediaKit: { title: "Media center", description: "Generate shareable images for rules, registration, calendar, season start and countdown.", section: "admin", keywords: ["media center", "media kit", "share image", "rules", "registration", "calendar", "season start", "countdown image", "countdown post"] },
    ...
    applicationAdmin: { title: "App management", description: "Manage users, locations and global controls.", section: "admin", keywords: ["superuser", "global users", "locations", "venues", "application"] },
    competitivePlayerImages: { title: "Competitive player images", description: "Manage the competitive image used in leagues without changing the global account image.", section: "admin", keywords: ["competitive image", "competitive photo", "player photo", "player image", "competitive avatar", "image override", "use global"] },
  ...
  eu: {
    ...
    appearance: { title: "Gaiak eta itxura", description: "Konbinatu gai argia, iluna edo sistemakoa Klasikoa edo Koloretsua estiloarekin.", section: "preferences", keywords: ["gaia", "modu iluna", "argia", "sistema", "klasikoa", "laua", "koloretsua", "estiloa", "koloreak", "diseinua", "paleta", "indigoa", "bioleta", "gau-urdina", "zeru-urdina", "salbia", "basoa", "borgoina", "arrosa hautseztatua", "harea", "terrakota", "grafitoa", "izotz-urdina"] },
    ...
    privacy: { title: "Pribatutasun politika", description: "Ikusi zer datu erabiltzen diren eta nola erabili zure eskubideak.", section: "help", keywords: ["pribatutasuna", "datuak", "rgpd", "datu babesa", "google", "eskubideak"] },
    terms: { title: "Erabilera baldintzak", description: "Ikusi aplikazioa erabiltzeko arauak eta erantzukizunak.", section: "help", keywords: ["baldintzak", "legal", "arauak", "erantzukizuna", "terminoak"] },
    ...
    adminView: { title: "Esperientzia modua", description: "Aldatu Administratzaile, Jokalari eta Jokalari esperientzia moduen artean benetako baimenak aldatu gabe.", section: "preferences", keywords: ["administratzailea", "admin ikuspegia", "jokalari modua", "jokalari esperientzia", "jokalaria simulatu", "admin baimenak"] },
    ...
    leagueIdentity: { title: "Ligaren identitatea", description: "Editatu izena, deskribapena, logotipoa eta gomendioak.", section: "league", keywords: ["logoa", "izena", "deskribapena", "irudia", "ligaren izena aldatu", "liga editatu", "ligaren logoa", "gomendioak"] },
    leagueRecommendations: { title: "Ligaren gomendioak", description: "Editatu jokalarientzako gomendatutako pilotak, pistak, ekipamendua eta aholkuak.", section: "league", keywords: ["gomendioa", "gomendioak", "pilotak", "pistak", "klubak", "ekipamendua", "materiala", "aholkuak", "liga gida"] },
    ...
    scheduledStart: { title: "Programatutako hasiera", description: "Programatu, aldatu edo desaktibatu hasi gabeko denboraldiaren hasiera-data eta ordua.", section: "season", keywords: ["programatutako hasiera", "programatutako denboraldia", "hasiera data", "hasiera ordua", "hasiera programatu", "atzerako kontaketa", "countdown"] },
    preseasonSecrets: { title: "Fase sekretua", description: "Aukeratu noiz erakutsi 1. jardunaldiko informazio segurua denboraldia hasi aurretik.", section: "season", keywords: ["fase sekretua", "sekretuak", "denboraldi-aurrea", "parekatzeak", "berriak", "programatutako hasiera"] },
    openingRound: { title: "Irekiera-jardunaldia", description: "Ezarri 1. jardunaldi bereziaren data, ordua eta kokapen komuna.", section: "season", keywords: ["irekiera jardunaldia", "irekiera", "irekiera data", "irekiera ordua", "irekiera kokapena", "1 jardunaldia"] },
    organizationBalls: { title: "Antolakuntzak esleitutako pilotak", description: "Ezarri zaindarien lehentasuna edo aukeratu zaindari izan daitezkeen jokalariak.", section: "season", keywords: ["antolakuntzak esleitutako pilotak", "pilota banaketa", "pilotak banatu", "piloten zaindaria", "zaindarien lehentasuna", "zaindariak aukeratu", "pilotak nork eraman"] },
    calendarVisibility: { title: "Egutegiaren ikusgarritasuna", description: "Aukeratu egutegi osoa edo parekatzeen desblokeo progresiboa.", section: "season", keywords: ["egutegi progresiboa", "desblokeo progresiboa", "parekatze sekretuak", "jardunaldia erakutsi", "ikusgarritasuna"] },
    rerollCalendar: { title: "Egutegiaren REROLL", description: "Sortu beste egutegi orekatu bat denboraldia hasi aurretik.", section: "season", keywords: ["reroll", "egutegia birsortu", "beste egutegi bat", "spoiler", "orekatua"] },
    ...
    registration: { title: "Izen-ematea", description: "Aktibatu, desaktibatu eta aldatu hasi gabeko denboraldiko kuota.", section: "season", keywords: ["kuota", "ordainketa", "zenbatekoa", "dirua", "izen-ematea aktibatu", "izen-ematea desaktibatu", "izen-ematerik gabe", "denboraldi kuota", "izen-emate prezioa", "izen-emate kontzeptua"] },
    seasonFinances: { title: "Denboraldiko ekonomia", description: "Ikusi izen-emateetatik jasotakoa, erregistratu gastuak eta kontrolatu saldo erabilgarria.", section: "admin", keywords: ["denboraldiko gastuak", "gastuak", "izen-emate dirua", "saldoa", "kutxa", "kontuak", "diru-sarrerak", "geratzen den dirua", "ekonomia", "kontabilitatea"] },
    ...
    mediaKit: { title: "Hedapen-zentroa", description: "Sortu partekatzeko irudiak arauentzat, izen-emateentzat, egutegiarentzat, hasierarentzat eta atzerako kontaketarentzat.", section: "admin", keywords: ["hedapen zentroa", "media kit", "irudia partekatu", "arauak", "izen-ematea", "egutegia", "atzerako kontaketa irudia", "atzerako kontaketa pieza"] },
    ...
    applicationAdmin: { title: "App-aren kudeaketa", description: "Kudeatu erabiltzaileak, kokapenak eta kontrol orokorrak.", section: "admin", keywords: ["supererabiltzailea", "erabiltzaile orokorrak", "kokapenak", "lekuak", "aplikazioa"] },
    competitivePlayerImages: { title: "Jokalarien lehia-irudiak", description: "Kudeatu ligetan erabiltzen den lehia-irudia kontuaren irudi globala aldatu gabe.", section: "admin", keywords: ["lehia irudia", "lehia argazkia", "jokalari argazkia", "jokalari irudia", "lehia avatarra", "irudi override", "globala erabili"] },
...
const routeById: Record<string, string> = {
  ...
  leagueRecommendations: "/admin/league#recomendaciones",
  ...
  scheduledStart: "/admin/season#inicio-programado",
  preseasonSecrets: "/admin/season#fase-secreta",
  openingRound: "/admin/season#margen-jornadas",
  organizationBalls: "/admin/season#bolas-organizacion",
  calendarVisibility: "/admin/season#visibilidad-calendario",
  rerollCalendar: "/admin/season#equilibrio-calendario",
  ...
  seasonFinances: "/admin/season/finances",
  ...
  mediaKit: "/admin/media-kit",
  substitutes: "/admin/substitutes",
  adminMvp: "/admin/mvp",
  exports: "/admin/exports",
  applicationAdmin: "/application-admin",
  competitivePlayerImages: "/application-admin/users",
  ...
  const ids = capabilities.isSpectator
    ...
    : [
        ...
        ...(capabilities.isSuperuser
          ? ["applicationAdmin", "competitivePlayerImages", "applicationSuggestions"]
          : []),
      ]
