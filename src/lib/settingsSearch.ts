...
const entryCopyByLocale: Record<Locale, Record<string, EntryCopy>> = {
  es: {
    ...
    organizationBalls: { title: "Bolas asignadas por la organización", description: "Configura la prioridad de custodios y consulta quién lleva las bolas en cada partido.", section: "season", keywords: ["bolas asignadas", "bolas de la organización", "bolas organizacion", "botes asignados", "reparto de botes", "custodio de bolas", "custodios", "encargado de las bolas"] },
  ...
  en: {
    ...
    organizationBalls: { title: "Organisation-assigned balls", description: "Set custodian priority and see who brings balls to each match.", section: "season", keywords: ["organization-assigned balls", "organisation-assigned balls", "ball allocation", "ball distribution", "ball custodian", "custodian priority", "who brings balls"] },
  ...
  eu: {
    ...
    organizationBalls: { title: "Antolakuntzak esleitutako pilotak", description: "Konfiguratu zaindarien lehentasuna eta ikusi nork eramango dituen pilotak partida bakoitzera.", section: "season", keywords: ["antolakuntzak esleitutako pilotak", "pilota banaketa", "pilotak banatu", "piloten zaindaria", "zaindarien lehentasuna", "pilotak nork eraman"] },
