...
const entryCopyByLocale: Record<Locale, Record<string, EntryCopy>> = {
  es: {
    ...
    preseasonSecrets: { title: "Fase secreta", description: "Configura cuándo se publica la información segura de la Jornada 1 antes de comenzar la temporada.", section: "season", keywords: ["fase secreta", "fase secretos", "secretos", "pretemporada", "emparejamientos", "jornada de apertura", "novedades", "inicio programado"] },
  ...
  en: {
    ...
    preseasonSecrets: { title: "Secret phase", description: "Choose when safe Round 1 information becomes visible before the season starts.", section: "season", keywords: ["secret phase", "preseason", "pairings", "opening round", "updates", "scheduled start"] },
  ...
  eu: {
    ...
    preseasonSecrets: { title: "Fase sekretua", description: "Aukeratu noiz erakutsi 1. jardunaldiko informazio segurua denboraldia hasi aurretik.", section: "season", keywords: ["fase sekretua", "sekretuak", "denboraldi-aurrea", "parekatzeak", "irekiera jardunaldia", "berriak", "programatutako hasiera"] },
