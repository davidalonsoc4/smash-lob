...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .sheet { page: sl-welcome-pack-portrait; width: 202mm; min-height: 289mm; display: grid; grid-template-columns: repeat(${WELCOME_PACK_BAG_SEAL.columnsPerA4}, ${WELCOME_PACK_BAG_SEAL.printedWidthMm}mm); grid-template-rows: repeat(${WELCOME_PACK_BAG_SEAL.rowsPerA4}, ${WELCOME_PACK_BAG_SEAL.printedHeightMm}mm); gap: 0; align-content: start; justify-content: center; break-after: page; page-break-after: always; }
    .sheet:last-child { break-after: auto; page-break-after: auto; }
    .seal-cell { --accent: ${accent}; position: relative; width: ${WELCOME_PACK_BAG_SEAL.printedWidthMm}mm; height: ${WELCOME_PACK_BAG_SEAL.printedHeightMm}mm; overflow: hidden; background: radial-gradient(circle at 18% 12%, color-mix(in srgb, var(--accent) 34%, transparent), transparent 28%), radial-gradient(circle at 82% 18%, rgba(255,255,255,.18) 0%, transparent 18%), radial-gradient(circle at 50% 76%, color-mix(in srgb, var(--accent) 18%, transparent), transparent 34%), linear-gradient(145deg, rgba(255,255,255,.04) 0%, rgba(255,255,255,0) 26%), linear-gradient(160deg, #191919 0%, #0A0A0A 48%, #020202 100%); }
    .seal-trim { position: absolute; inset: ${WELCOME_PACK_BAG_SEAL.bleedMm}mm; display: grid; grid-template-rows: ${WELCOME_PACK_BAG_SEAL.faceHeightMm}mm ${WELCOME_PACK_BAG_SEAL.faceHeightMm}mm; overflow: hidden; background: transparent; }
