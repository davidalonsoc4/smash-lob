...
import { RequiresThreeSetsSettingsPanel, RoundWindowSettingsPanel, ProgressiveCalendarSettingsPanel, ResultConfirmationSettingsPanel, MvpSystemSettingsPanel, RegistrationFeeSettingsPanel } from "@/components/admin/season/SeasonRulesSettings";
