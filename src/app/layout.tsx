      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var l=localStorage.getItem('smash-lob-theme');var m=localStorage.getItem('smash-lob-theme-mode');var s=localStorage.getItem('smash-lob-visual-style');var p=localStorage.getItem('smash-lob-colorful-palette')||'indigo';var tm=['light','dark','system'];var vs=['plain','colorful'];var ps=['indigo','ocean','emerald','coral','sunset'];if(tm.indexOf(m)<0)m=tm.indexOf(l)>=0?l:'light';if(vs.indexOf(s)<0)s=l==='colorful'?'colorful':'plain';if(ps.indexOf(p)<0)p='indigo';var d=m==='dark'||(m==='system'&&window.matchMedia('(prefers-color-scheme: dark)').matches);var c=s==='colorful';var r=d?'dark':'light';var h={indigo:{light:'#5b5ce2',dark:'#17172e'},ocean:{light:'#087ea4',dark:'#082b35'},emerald:{light:'#059669',dark:'#082c24'},coral:{light:'#e65a72',dark:'#351923'},sunset:{light:'#f06a24',dark:'#321d22'}};var e=document.documentElement;e.classList.toggle('dark',d);e.classList.toggle('colorful',c);e.dataset.theme=r;e.dataset.style=s;e.dataset.colorfulPalette=p;e.style.colorScheme=r;var mt=document.querySelector('meta[name="theme-color"]');if(mt)mt.setAttribute('content',c?h[p][r]:d?'#0f0f10':'#0a0a0a')}catch(e){}})();`,
          }}
        />
      </head>
      <body>
