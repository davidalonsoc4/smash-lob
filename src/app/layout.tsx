      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var l=localStorage.getItem('smash-lob-theme');var m=localStorage.getItem('smash-lob-theme-mode');var s=localStorage.getItem('smash-lob-visual-style');var p=localStorage.getItem('smash-lob-colorful-palette')||'graphite';var tm=['light','dark','system'];var vs=['plain','colorful'];var ps=['indigo','midnight','sage','burgundy','terracotta','graphite'];var pm={ocean:'midnight',emerald:'sage',coral:'burgundy',sunset:'terracotta'};if(tm.indexOf(m)<0)m=tm.indexOf(l)>=0?l:'light';if(vs.indexOf(s)<0)s=l==='colorful'?'colorful':tm.indexOf(l)>=0?'plain':'colorful';if(ps.indexOf(p)<0)p=pm[p]||'graphite';var d=m==='dark'||(m==='system'&&window.matchMedia('(prefers-color-scheme: dark)').matches);var c=s==='colorful';var r=d?'dark':'light';var h={indigo:{light:'#5b5ce2',dark:'#17172e'},midnight:{light:'#365f9d',dark:'#0d1726'},sage:{light:'#55765f',dark:'#101b15'},burgundy:{light:'#8b3f57',dark:'#241219'},terracotta:{light:'#a95640',dark:'#251713'},graphite:{light:'#4f6379',dark:'#121820'}};var e=document.documentElement;e.classList.toggle('dark',d);e.classList.toggle('colorful',c);e.dataset.theme=r;e.dataset.style=s;e.dataset.colorfulPalette=p;e.style.colorScheme=r;var mt=document.querySelector('meta[name="theme-color"]');if(mt)mt.setAttribute('content',c?h[p][r]:d?'#0b1119':'#0a0a0a')}catch(e){}})();`,
          }}
        />
