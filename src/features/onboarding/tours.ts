...
const tourStructure: Array<{
  ...
  { key: "chat", version: 6, route: "/match/:id/chat", audience: players, steps: [{ selector: "[data-tour='chat-messages']", side: "center" }, { selector: "[data-tour='chat-proposals']", side: "top" }] },
  {
    key: "match",
    version: 1,
    route: "/match/:id",
