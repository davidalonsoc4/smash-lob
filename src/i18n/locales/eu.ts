export const eu = {
  ...
  settings: {
    ...
    colorfulPaletteOcean: "Urdina eta turkesa",
    colorfulPaletteOceanDescription: "Freskoa, garbia eta argitsua.",
    colorfulPaletteEmerald: "Esmeralda berdea",
    colorfulPaletteEmeraldDescription: "Naturala, kirol-itxurakoa eta kontraste handikoa.",
    colorfulPaletteCoral: "Korala eta arrosa",
    colorfulPaletteCoralDescription: "Beroa, energetikoa eta adierazkorra.",
    colorfulPaletteSunset: "Laranja eta morea",
    colorfulPaletteSunsetDescription: "Bizia, dinamikoa eta kontraste handiagokoa.",
