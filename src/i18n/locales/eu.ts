export const eu = {
  ...
  settings: {
    ...
    profileImageTitle: "Liga honetako avatarra",
    profileImageDescription: "Erabili beste irudi bat liga honetan. Kentzean, kontuko irudia edo avatar lehenetsia berreskuratuko da.",
    ...
    avatarCustomActive: "Avatar pertsonalizatua aktibo dago liga honetan.",
    avatarGoogleFallback: "Kontuko zure irudia erabiltzen da lehenespenez.",
    avatarInitialsFallback:
      "Irudirik igotzen ez baduzu, zure inizialak erabiliko dira.",
    uploadAvatar: "Avatarra igo",
    removeAvatar: "Avatarra kendu",
    avatarSaved: "Ligako avatarra gordeta.",
    avatarSaveError:
