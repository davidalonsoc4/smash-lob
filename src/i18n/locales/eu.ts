export const eu = {
  ...
  matches: {
    ...
    byeRoundTitle: "JARDUNALDI HONETAN ATSEDEN DUZU",
    byeRoundDescription: "Jardunaldi honetan ez duzu partidarik. Atsedenak modu orekatuan banatzen dira jokalari guztien artean.",
  },
  ...
  settings: {
    ...
    colorfulPaletteDescription: "Aukeratu estilo Klasikoaren paleta.",
    colorfulPaletteClassic: "Normala",
    colorfulPaletteClassicDescription: "Kolore lauak eta aplikazioaren itxura klasikoa.",
    competitionAccentTitle: "Competition-en azentua",
    competitionAccentDescription: "Aukeratu liga honetako Competition moduaren kolore nagusia.",
    competitionAccentLeague: "Ligaren kolorea",
    competitionAccentLeagueDescription: "Erabili une honetan aktibo dagoen ligan ezarritako kolorea.",
    competitionAccentGold: "Urrea",
    competitionAccentGoldDescription: "Urre bero eta kirol-itxurakoa.",
    competitionAccentBlue: "Lehiaketako urdina",
    competitionAccentBlueDescription: "Urdin garbi eta energetikoa.",
    competitionAccentGreen: "Pistako berdea",
    competitionAccentGreenDescription: "Berde orekatua eta naturala.",
    competitionAccentCoral: "Korala",
    competitionAccentCoralDescription: "Korala, ekintza nagusiak nabarmentzeko.",
    competitionAccentViolet: "Bioleta",
    competitionAccentVioletDescription: "Bioleta moderno eta teknologikoa.",
    competitionAccentIce: "Izotz-urdina",
    competitionAccentIceDescription: "Urdin argia, kontraste hotzarekin.",
    leagueAccentColor: "Ligaren azentu-kolorea",
    leagueAccentDescription: "Competition-en eta ligaren ikusizko elementuetan erabiltzen da.",
    leagueAccentSaveError: "Ezin izan da ligaren azentu-kolorea gorde.",
  ...
  adminSeason: {
    ...
    decreasePlayerCount: "Jokalari kopurua murriztu",
    increasePlayerCount: "Jokalari kopurua handitu",
    playersShortLabel: "jokalari",
    playerCountRangeDescription: "Aukeratu 8 eta 24 jokalari artean. Tamaina jokalariz jokalari doi dezakezu.",
    playerCountBalancedDescription: "Tamaina honek egutegi guztiz orekatua ahalbidetzen du: denek jardunaldi guztietan jokatzen dute, atsedenik gabe.",
    playerCountRequiresByesDescription: "Atsedenak dituen egutegi orekatua: jardunaldi bakoitzean {count} jokalarik atseden hartzen dute eta denek atseden kopuru bera dute.",
    ...
    calendarDescription:
      "Lehenik aukeratu parekatzeak nola sortuko diren. Iraupena bereizita konfiguratzen da hurrengo blokean.",
    seasonLengthTitle: "Iraupena",
    seasonLengthDescription:
      "Ondoren aukeratu denboraldiak zenbat jardunaldi izango dituen: iraupen orekatu osoa edo kopuru pertsonalizatua.",
    durationCompleteTitle: "Orekatua osoa",
    durationCompleteDescription: "Smash & Lob-ek automatikoki kalkulatzen ditu itzuli oso bat edo gehiago, oreka-baldintzak mantenduz.",
    durationRecommended: "Gomendatua",
    durationCustomTitle: "Pertsonalizatua",
    durationCustomDescription: "Aukeratu jardunaldi kopuru zehatza eta ahalik eta egutegi orekatuena sortuko da.",
    longMultiplierLabel: "Itzuli osoen kopurua",
    longMultiplierHelp: "Uneko jokalariekin formatu honek gehienez ×{max} itzuli oso orekatu ({rounds} jardunaldi) onartzen ditu.",
    customRoundCountLabel: "Jardunaldi kopurua",
    customRoundCountHelp: "1 eta {max} jardunaldi artean aukeratu dezakezu. Balioa itzuli oso baten multiploa bada, automatikoki sorrera perfektu orekatua erabiltzen da.",
    perfectDurationBadge: "Oreka osoa · {count} itzuli oso",
    optimizedDurationBadge: "Oreka optimoa {rounds} jardunaldirako",
    ...
    extendedCalendarDescription:
      "Itzuli oso, orekatu eta desberdinak kateatzen ditu algoritmoak onartzen duen gehienekora arte.",
    balancedCalendar: "Egutegi orekatua",
    balancedCalendarDescription:
      "Jardunaldi orekatuak automatikoki sortzen ditu, bikoteak, aurkariak eta, behar denean, atsedenak ere banatuz.",
    ...
    calendarAuditOptimized: "Optimizatua",
    ...
    calendarAuditMatchesPerRound: "Partidak jardunaldiko",
    calendarAuditMatchesPerRoundOk: "{count} partida jardunaldi bakoitzean",
    calendarAuditMatchesPerRoundError: "{count} jardunaldik partida kopuru okerra dute",
    calendarAuditSingleAppearanceError: "{count} agerraldi oker",
    calendarAuditMaxOneAppearance: "Gehienez agerraldi bat jardunaldiko",
    calendarAuditMaxOneAppearanceOk: "Inork ez du partida bat baino gehiago jokatzen jardunaldi berean",
    calendarAuditByesPerRound: "Atsedenak jardunaldiko",
    calendarAuditByesPerRoundOk: "{count} atseden jardunaldi bakoitzean",
    calendarAuditByesPerRoundError: "{count} jardunaldik atseden kopuru okerra dute",
    calendarAuditByesPerPlayer: "Atsedenak jokalariko",
    calendarAuditByesPerPlayerOk: "{count} atseden jokalari bakoitzeko denboraldian",
    calendarAuditByesPerPlayerRange: "Jokalari bakoitzeko {min} eta {max} atseden artean, gehienez 1eko aldearekin",
    calendarAuditByesPerPlayerError: "{count} jokalarik atseden banaketa okerra dute",
    calendarAuditNoConsecutiveByes: "Jarraian atsedenik ez",
    calendarAuditNoConsecutiveByesOk: "Inork ez du bi jardunaldi jarraian atseden hartzen",
    calendarAuditNoConsecutiveByesError: "Jarraian hartutako {count} atseden detektatu dira",
    calendarAuditQuartets: "Errepikatu gabeko laukoteak",
    calendarAuditQuartetsOk: "4 jokalariko talde bera ez da errepikatzen itzuli berean",
    calendarAuditQuartetsError: "{count} laukote errepikatu dira itzuli berean",
    ...
    calendarAuditFlexiblePartners: "Bikoterik ez da errepikatzen itzuli berean.",
    calendarAuditFlexibleOpponents: "Gehienez {count} partida aurkari beraren kontra itzuliko.",
    calendarAuditDurationBalance: "Iraupenaren oreka",
    calendarAuditDurationPerfect: "{count} itzuli oso eta orekatu",
    calendarAuditDurationOptimized: "{complete} itzuli oso + {partial} jardunaldi optimizatu · jokalari bakoitzeko partidak: {min}-{max}",
    calendarAuditExtendedStructure: "Partida zehatzik errepikatu gabe",
    calendarAuditMaxPartnerFrequency: "Gehienez {count} partida bikote berarekin, aniztasuna lehenetsiz.",
    calendarAuditMaxOpponentFrequency: "Gehienez {count} partida aurkari beraren aurka, aniztasuna lehenetsiz.",
    ...
    secretPairingsTitle: "Parekatze sekretuak",
    secretPairingsCalendarHelp: "Aurreko jardunaldia amaitzean erakutsiko dira edo, beranduenez, jardunaldi hau hasten denean.",
    secretRoundDetailHelp: "Jardunaldi hau oraindik ez da erakutsi. Aurrekoa amaitzean desblokeatuko da edo, beranduenez, bere hasiera-data iristean.",
    experienceModeError: "Ezin izan da esperientzia-modua aldatu.",
    experienceModeTitle: "Esperientzia-modua",
    experienceModeDescription: "Aukeratu liga hau nola bizi nahi duzun administratzaile gisa dituzun benetako baimenak aldatu gabe.",
    experienceAdminTitle: "ADMINISTRATZAILEA",
    experienceAdminDescription: "Administrazio-informazio eta kontrol guztiekin ikuspegi osoa.",
    experiencePlayerDescription: "Bizi liga beste edozein jokalarik bezala. Ezarpen hau bakarrik egongo da erabilgarri administratzaile modura itzultzeko.",
    experienceHybridTitle: "JOKALARI ESPERIENTZIA",
    experienceHybridDescription: "Lehiaketako pantailak jokalari gisa portatzen dira, baina Administrazioa erabilgarri mantentzen da.",
    calendarVisibilityRevealError: "Ezin izan da hurrengo jardunaldia erakutsi.",
    calendarVisibilityRevealConfirm: "{round}. jardunaldiko parekatzeak erakutsiko dira. Ekintza hau ezin da desegin. Jarraitu?",
    roundUnlockedTitle: "{round}. jardunaldia desblokeatuta",
    roundUnlockedBody: "Orain {round}. jardunaldiko parekatzeak ikus ditzakezu eta partida antolatzen hasi.",
    roundCompletedRevealBody: "{completedRound}. jardunaldia amaitu da. Orain {nextRound}. jardunaldiko parekatzeak ikus ditzakezu eta partida antolatzen hasi.",
    openingRoundTitle: "Irekiera-jardunaldi berezia",
    openingRoundDescription: "1. jardunaldia irekiera-ekitaldi gisa jokatzen da. Ohiko erritmoa 2. jardunaldian hasten da.",
    openingRoundDateTime: "Irekiera-jardunaldiaren data eta ordua",
    openingRoundScheduledStartHelp: "Denboraldiak hasiera programatua duenez, Irekiera-jardunaldiak automatikoki data eta ordu bera erabiliko ditu. Kokapena bakarrik aukeratu behar duzu.",
    openingRoundLocation: "Irekiera-jardunaldiaren kokapena",
    openingRoundLocationPlaceholder: "Hautatu kokapen bat",
    openingRoundAutoScheduleHelp: "Gordetzean, 1. jardunaldiko partida guztiei data, ordua eta kokapena automatikoki aplikatuko zaizkie, pista zehaztu gabe.",
    openingRoundLocked: "Irekiera-jardunaldia finkatuta geratzen da denboraldia hasten denean.",
    regularLeagueStart: "Liga erregularraren hasiera (2. jardunaldia)",
    openingRoundCreateDescription: "1. jardunaldiak data eta ordu bakarra izango du. 2. jardunaldiak ohiko erritmoari hasiera emango dio.",
    openingRoundCreateAutoHelp: "Data, ordua eta kokapena automatikoki aplikatuko zaizkie 1. jardunaldiko partida guztiei. Pista zehatza gero aukeratu ahal izango da.",
    openingRoundInvalid: "Data edo ordua ez da baliozkoa.",
    calendarVisibilityTitle: "Parekatzeen ikusgaitasuna",
    calendarVisibilityDescription: "Aukeratu jokalariek egutegi osoa ezagutuko duten edo jardunaldiak pixkanaka ezagutuko dituzten.",
    calendarVisibilityFullTitle: "Egutegi osoa",
    calendarVisibilityFullDescription: "Jokalariek parekatze guztiak hasieratik ikus ditzakete.",
    calendarVisibilityProgressiveTitle: "Desblokeatze progresiboa",
    calendarVisibilityProgressiveDescription: "Hurrengo jardunaldia aurrekoa amaitzean erakusten da eta, beranduenez, hasiera-data ofiziala iristean.",
    newCalendarVisibilityFullDescription: "Parekatze guztiak hasieratik daude ikusgai.",
    newCalendarVisibilityProgressiveDescription: "Jardunaldi bakoitza aurrekoa amaitzean erakusten da eta, beranduenez, bere hasiera-data iristean.",
    calendarVisibilitySave: "Ikusgaitasuna gorde",
    calendarVisibilitySaving: "Gordetzen...",
    calendarVisibilityProgressiveEnabled: "Desblokeatze progresiboa aktibatuta.",
    calendarVisibilityFullEnabled: "Egutegi osoa ikusgai jokalarientzat.",
    calendarVisibilitySaveError: "Ezin izan da egutegiaren ikusgaitasuna gorde.",
    calendarVisibilityVisibleNow: "Orain ikusgai",
    calendarVisibilityThroughRound: "{round}. jardunaldira arte",
    calendarVisibilityNoneRevealed: "Ez da parekatzerik erakutsi",
    calendarVisibilityRevealRound: "Erakutsi {round}. jardunaldia orain",
    calendarVisibilityAllRevealed: "Denboraldiko parekatze guztiak dagoeneko erakutsi dira.",
    calendarVisibilitySaveFirst: "Gorde lehenik modu progresiboa jardunaldiak eskuz erakutsi aurretik.",
    expandSeasonEyebrow: "Denboraldia luzatu",
    expandSeasonDescription: "Egutegia birsortu dezakezu itzuli bikoitzera edo denboraldi luzera hedatzeko. Jokalari hauekin gehieneko orekatua ×{max} da ({rounds} jardunaldi).",
    expandSeasonBlockedByResults: "Ezin da denboraldia luzatu, dagoeneko emaitzak erregistratuta daudelako.",
    expandSeasonAtMaximum: "Denboraldia dagoeneko gehieneko luzera orekatuan dago: {rounds} jardunaldi.",
    expandDoubleButton: "Itzuli bikoitzera luzatu · {rounds} jardunaldi",
    expandLongLabel: "Denboraldi luzearen iraupena",
    expandLongButton: "Denboraldi luzera hedatu",
    expandSeasonConfirm: "Egutegi osoa birsortuko da eta denboraldiak {rounds} jardunaldi izango ditu. Aurreko partidei lotutako programazioak, erreserbak eta txatak ezabatuko dira; konfiguratutako Irekiera Jardunaldia mantenduko da. Emaitzarik erregistratu ez bada bakarrik jarraituko du. Jarraitu?",
    expandSeasonSuccess: "Denboraldia luzatu da eta egutegi orekatua {rounds} jardunaldirekin birsortu da.",
    rerollEyebrow: "Spoilerrak saihestu",
    rerollDescription: "REROLL-ek beste egutegi orekatu bat sortzen du oraingoa perfektua bada ere. Emaitzarik erregistratu ez den bitartean erabil daiteke. Aurreko parekatzeei lotutako programazioak, erreserbak eta txatak ezabatzen dira, baina konfiguratutako Irekiera Jardunaldia mantentzen da.",
    rerollButton: "REROLL · Beste egutegi bat sortu",
    rerollGenerating: "Sortzen...",
    rerollConfirm: "Parekatze desberdinak dituen beste egutegi orekatu bat sortuko da. Aurreko parekatzeei lotutako programazioak, erreserbak eta txatak ezabatuko dira. Konfiguratutako Irekiera Jardunaldia mantenduko da. REROLL emaitzak dagoenean bakarrik blokeatzen da. Jarraitu?",
    rerollSuccess: "Egutegi orekatua parekatze berriekin birsortu da.",
    rerollBlockedByResults: "Ezin da REROLL egin denboraldi honetan emaitzak erregistratuta daudelako.",
  ...
  notifications: {
    ...
    preferences: {
      match_schedule: { title: "Partiden programazioa", description: "Zure partiden datak, orduak, pistak, aldaketak eta pilotak eramateko esleipenak." },
      ...
      match_upcoming: { title: "Hurrengo partida", description: "Partida hasi aurreko gogorarazpena, pilotak eramatea dagokizunean ere." },
  ...
  activity: {
    ...
    notificationLabels: {
      ...
      match_ball_custodian_assigned: "Pilotak eramatea dagokizu",
      match_ball_custodian_reminder: "Pilotak eramateko gogorarazpena",
      match_chat_message: "Chat mezu berria",
      round_in_play: "Jardunaldia jokoan",
      round_pairings_revealed: "Jardunaldia desblokeatuta",
    ...
    labels: {
      ...
      match_ball_custodian_assigned: "Piloten ardura",
      match_ball_custodian_reminder: "Piloten ardura",
      match_chat_message: "Chat",
      round_in_play: "Jardunaldia",
      round_pairings_revealed: "Jardunaldia",
