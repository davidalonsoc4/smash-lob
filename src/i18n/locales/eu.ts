export const eu = {
  ...
  invites: {
    ...
    selfRegistrationProfileNotice: "Ez duzu jokalaririk aukeratu behar: ligako zure profila automatikoki sortu edo berrerabiliko da.",
  ...
  settings: {
    ...
    visualStylePlain: "Laua",
    visualStylePlainDescription: "Neutroa, diskretua eta apaingarri gehigarririk gabe.",
