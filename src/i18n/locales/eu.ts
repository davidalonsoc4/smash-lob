export const eu = {
  ...
  adminSeason: {
    ...
    rerollDescription: "REROLL-ek beste egutegi orekatu bat sortzen du oraingoa perfektua bada ere. Denboraldia hasi aurretik bakarrik dago erabilgarri eta ez ditu inoiz aldatuta edo erreserbatuta dauden partidak ordezkatzen.",
    rerollButton: "REROLL · Beste egutegi bat sortu",
    rerollGenerating: "Sortzen...",
    rerollConfirm: "Parekatze desberdinak dituen beste egutegi orekatu bat sortuko da. Irekiera-jardunaldiaren data automatikoa mantenduko da. Jarraitu?",
