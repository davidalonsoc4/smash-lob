export const eu = {
  ...
  matchDetail: {
    ...
    customLocation: "Leku pertsonalizatua",
    customLocationPlaceholder: "Idatzi partidaren lekua",
  ...
  adminLeague: {
    ...
    googleLocation: "Google kokapena",
    googleLocationPlaceholder: "Bilatu eta aukeratu kiroldegia edo kluba",
    address: "Helbidea",
    addressPlaceholder: "Eskuzko helbidea Google erabili ezean",
    duplicatedLocation: "Leku hori dagoeneko zerrendan dago.",
    addLocation: "Lekua gehitu",
    removeLocation: "Kendu",
    openMaps: "Maps",
    openWaze: "Waze",
    googleApiMissing: "Google Places bilaketa ez dago konfiguratuta. Eskuzko helbidea gorde dezakezu eta Maps/Waze aplikazioetan bilaketa bidez irekiko da.",
