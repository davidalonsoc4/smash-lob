export const es = {
  ...
  settings: {
    ...
    colorfulPaletteOcean: "Azul y turquesa",
    colorfulPaletteOceanDescription: "Fresca, limpia y luminosa.",
    colorfulPaletteEmerald: "Verde esmeralda",
    colorfulPaletteEmeraldDescription: "Natural, deportiva y con alto contraste.",
    colorfulPaletteCoral: "Coral y rosa",
    colorfulPaletteCoralDescription: "Cálida, enérgica y expresiva.",
    colorfulPaletteSunset: "Naranja y púrpura",
    colorfulPaletteSunsetDescription: "Intensa, dinámica y con mayor contraste.",
