export const es = {
  ...
  accountProfile: {
    ...
    description: "Confirma tu nombre, tu posición preferida y tu mano dominante.",
    firstName: "Nombre",
    lastName: "Primer apellido",
    preferredSide: "Posición preferida",
    preferredSideNone: "Sin indicar",
    preferredSideDrive: "Drive",
    preferredSideBackhand: "Revés",
    preferredSideVersatile: "Versátil",
    preferredSideRequired: "Selecciona Drive, Revés o Versátil para continuar.",
    preferredSideDescription: "Información orientativa para que los demás sepan dónde juegas más cómodo.",
    dominantHand: "Mano dominante",
    dominantHandNone: "Sin indicar",
    dominantHandRight: "Derecha",
    dominantHandLeft: "Izquierda",
    dominantHandRequired: "Selecciona tu mano dominante para continuar.",
    dominantHandDescription: "La mostraremos junto a tu posición como diestro o zurdo.",
  ...
  roster: {
    ...
    title: "Plantilla de la temporada",
    remaining: "Quedan {count} plazas disponibles.",
    complete: "La plantilla está completa. La organización ya puede comenzar la temporada.",
    availableSlot: "Plaza disponible",
    joinAction: "Unirme a esta temporada",
    leaveAction: "Liberar plaza",
    leaveConfirm: "¿Seguro que quieres liberar esta plaza antes de comenzar la temporada?",
    joinError: "No se ha podido ocupar la plaza.",
  ...
  invites: {
    ...
    selfRegistrationTitle: "Inscríbete en la temporada",
    selfRegistrationDescription: "Tu cuenta ocupará una plaza disponible usando el nombre de tu perfil global.",
    selfRegistrationProfileNotice: "Tu perfil de la liga usará el nombre de tu cuenta. Si ya jugaste una temporada anterior, puedes recuperar ese historial antes de ocupar la plaza.",
    historicalIdentityTitle: "¿Ya jugaste una temporada anterior?",
    historicalIdentityDescription: "Selecciona el nombre con el que aparecías en el histórico. Sus partidos, clasificación y estadísticas quedarán vinculados a tu cuenta y pasarán a mostrar tu nombre actual.",
    historicalIdentityNewPlayer: "No, soy un jugador nuevo",
    historicalIdentityRequired: "Indica si eres uno de los jugadores del histórico o si entras como jugador nuevo.",
    historicalIdentityUnavailable: "Ese jugador histórico ya no está disponible. Actualiza la invitación y vuelve a elegir.",
    historicalIdentitySelected: "Historial que se vinculará",
    selfRegistrationAction: "Aceptar y ocupar una plaza",
    ...
    profileIncomplete: "Completa primero tu nombre y primer apellido.",
    rosterFull: "La plantilla ya está completa y no quedan plazas libres.",
    registrationClosed: "La inscripción de esta temporada ya está cerrada.",
  ...
  settings: {
    ...
    appearanceTitle: "Temas y apariencia",
    appearanceDescription: "Combina el tema base, el estilo visual y la paleta en este dispositivo.",
    appearancePageTitle: "Temas y apariencia",
    appearancePageDescription: "Combina luminosidad, estilo y color sin cambiar el funcionamiento de la aplicación.",
    appearanceCurrent: "Configuración actual",
    appearanceDeviceOnly: "La configuración visual se guarda únicamente en este dispositivo.",
    themeModeTitle: "Tema base",
    themeModeDescription: "Elige una base clara, oscura o automática según el dispositivo.",
    ...
    visualStyleColorful: "Colorido",
    visualStyleColorfulDescription: "Añade degradados, profundidad y la paleta elegida.",
    appearanceLight: "Claro",
    appearanceLightDescription: "Limpio y luminoso.",
    appearanceDark: "Oscuro",
    appearanceDarkDescription: "Cómodo con poca luz.",
    appearanceSystem: "Sistema",
    appearanceSystemDescription: "Sigue el ajuste del dispositivo.",
    appearanceColorful: "Colorido",
    appearanceColorfulDescription: "Más vivo, con acentos y fondos suaves.",
    colorfulPaletteTitle: "Paleta de color",
    colorfulPaletteDescription: "Elige la combinación principal del modo Colorido.",
    colorfulPaletteIndigo: "Índigo y violeta",
    colorfulPaletteIndigoDescription: "Equilibrada, tecnológica y con acentos rosas.",
    colorfulPaletteMidnight: "Azul noche y celeste",
    colorfulPaletteMidnightDescription: "Deportiva, limpia y con profundidad azul marino.",
    colorfulPaletteSage: "Salvia y bosque",
    colorfulPaletteSageDescription: "Natural, serena y con verdes apagados.",
    colorfulPaletteBurgundy: "Borgoña y rosa empolvado",
    colorfulPaletteBurgundyDescription: "Elegante, cálida y con contraste contenido.",
    colorfulPaletteTerracotta: "Arena y terracota",
    colorfulPaletteTerracottaDescription: "Cálida, orgánica y sin naranjas estridentes.",
    colorfulPaletteGraphite: "Grafito y azul hielo",
    colorfulPaletteGraphiteDescription: "Neutra, moderna y con un toque frío discreto.",
    leagueSearchTitle: "Buscar ligas",
    leagueSearchPlaceholder: "Nombre, temporada o rol",
    leagueSearchAvailable: "ligas disponibles",
    leagueSearchAll: "Todas las ligas",
    leagueSearchResults: "Resultados",
    leagueSearchNoResultsTitle: "No hay ligas que coincidan",
    leagueSearchNoResultsDescription: "Prueba con otro nombre, temporada o rol.",
    leagueSearchCurrent: "Actual",
    leagueSearchCreator: "Creador",
    leagueSearchAdmin: "Administrador",
    leagueSearchPlayer: "Jugador",
    leagueSearchSpectator: "Espectador",
    leagueSearchNoSeason: "Sin temporada activa",
    leagueSearchClose: "Cerrar buscador de ligas",
    leagueSearchClear: "Borrar búsqueda",
    ...
    profileImageDescription: "Esta imagen pertenece a tu cuenta y se utiliza en todas tus ligas. Al quitarla volverás a la imagen de Google o al avatar predeterminado.",
    ...
    accountSettingsDescription:
      "Personaliza la imagen global que se muestra en todas tus ligas.",
    connectedEmail: "Email conectado",
    joinNewExistingLeague: "Unirme a una nueva liga existente",
    avatarCustomActive: "Imagen personalizada activa en tu cuenta.",
    avatarGoogleFallback: "Se usa la imagen global de tu cuenta.",
    avatarInitialsFallback: "Se usan tus iniciales si no subes imagen.",
    uploadAvatar: "Subir imagen",
    removeAvatar: "Quitar imagen",
    avatarSaved: "Imagen de perfil guardada.",
    avatarSaveError:
  ...
  adminSeason: {
    ...
    selfRegistrationWaitingTitle: "Plantilla por autoinscripción",
    selfRegistrationWaitingDescription: "La temporada se creará con {count} plazas. Los nombres aparecerán cuando los usuarios se unan.",
    selfRegistrationCreatorNotice: "Tu perfil ocupará la primera plaza. El calendario se generará cuando la plantilla esté completa y comiences la temporada.",
    selfRegistrationCalendarDescription: "El calendario equilibrado se generará al comenzar la temporada con todos los jugadores inscritos.",
    rosterModeTitle: "¿Cómo se formará la plantilla?",
    rosterModeFixedTitle: "Plantilla preparada por la organización",
    rosterModeFixedDescription: "El creador escribe o selecciona los jugadores antes de crear la temporada.",
    rosterModeSelfTitle: "Jugadores se registran al unirse",
    rosterModeSelfDescription: "Indica solo el número de plazas. Los nombres aparecerán a medida que los usuarios entren con su perfil.",
    ...
    secretPairingsTitle: "Emparejamientos secretos",
    secretPairingsCalendarHelp: "Se revelarán cuando finalice la jornada anterior o, como máximo, al comenzar esta jornada.",
    secretRoundDetailHelp: "Esta jornada todavía no ha sido revelada. Se desbloqueará al finalizar la anterior o, como máximo, al llegar su fecha de inicio.",
    experienceModeError: "No se ha podido cambiar el modo de experiencia.",
    experienceModeTitle: "Modo de experiencia",
    experienceModeDescription: "Elige cómo quieres vivir esta liga sin cambiar tus permisos reales de administrador.",
    experienceAdminTitle: "ADMINISTRADOR",
    experienceAdminDescription: "Vista completa con información y controles de administración.",
    experiencePlayerDescription: "Vive la liga como cualquier jugador. Solo este ajuste seguirá permitiéndote volver a modo admin.",
    experienceHybridTitle: "EXPERIENCIA JUGADOR",
    experienceHybridDescription: "Las pantallas de competición se comportan como jugador, pero Administración sigue disponible.",
    calendarVisibilityRevealError: "No se ha podido revelar la siguiente jornada.",
    calendarVisibilityRevealConfirm: "Se revelarán los emparejamientos de la Jornada {round}. Esta acción no se puede deshacer. ¿Continuar?",
    roundUnlockedTitle: "Jornada {round} desbloqueada",
    roundUnlockedBody: "Ya puedes consultar los emparejamientos de la Jornada {round} y empezar a organizar el partido.",
    roundCompletedRevealBody: "La Jornada {completedRound} ha terminado. Ya puedes consultar los emparejamientos de la Jornada {nextRound} y empezar a organizar el partido.",
    openingRoundTitle: "Jornada de Apertura especial",
    openingRoundDescription: "La Jornada 1 se juega como evento de apertura. La cadencia normal empieza en la Jornada 2.",
    openingRoundDateTime: "Fecha y hora de Jornada de Apertura",
    openingRoundScheduledStartHelp: "Como esta temporada tiene Inicio programado, la Jornada de Apertura usará automáticamente esa misma fecha y hora. Solo tienes que elegir la ubicación.",
    openingRoundLocation: "Ubicación de Jornada de Apertura",
    openingRoundLocationPlaceholder: "Selecciona una ubicación",
    openingRoundAutoScheduleHelp: "Al guardar, todos los partidos de Jornada 1 quedarán programados automáticamente con esta fecha, hora y ubicación, sin asignar pista.",
    openingRoundLocked: "La Jornada de Apertura queda fijada cuando comienza la temporada.",
    regularLeagueStart: "Inicio de Liga Regular (Jornada 2)",
    openingRoundCreateDescription: "La Jornada 1 tendrá una fecha y hora única. La Jornada 2 será el inicio de la cadencia regular.",
    openingRoundCreateAutoHelp: "Esta fecha, hora y ubicación se aplicarán automáticamente a todos los partidos de Jornada 1. La pista concreta se decidirá después.",
    openingRoundInvalid: "Fecha y hora no válidas.",
    calendarVisibilityTitle: "Visibilidad de emparejamientos",
    calendarVisibilityDescription: "Decide si los jugadores conocen todo el calendario o van descubriendo cada jornada progresivamente.",
    calendarVisibilityFullTitle: "Calendario completo",
    calendarVisibilityFullDescription: "Los jugadores pueden consultar todos los emparejamientos desde el principio.",
    calendarVisibilityProgressiveTitle: "Desbloqueo progresivo",
    calendarVisibilityProgressiveDescription: "La siguiente jornada se revela al finalizar la anterior y, como máximo, al llegar su fecha oficial de inicio.",
    newCalendarVisibilityFullDescription: "Todos los emparejamientos son visibles desde el inicio.",
    newCalendarVisibilityProgressiveDescription: "Cada jornada se revela al terminar la anterior y, como máximo, al llegar su fecha de inicio.",
    calendarVisibilitySave: "Guardar visibilidad",
    calendarVisibilitySaving: "Guardando...",
    calendarVisibilityProgressiveEnabled: "Desbloqueo progresivo activado.",
    calendarVisibilityFullEnabled: "Calendario completo visible para los jugadores.",
    calendarVisibilitySaveError: "No se ha podido guardar la visibilidad del calendario.",
    calendarVisibilityVisibleNow: "Visible ahora",
    calendarVisibilityThroughRound: "Hasta Jornada {round}",
    calendarVisibilityNoneRevealed: "Ningún emparejamiento revelado",
    calendarVisibilityRevealRound: "Revelar Jornada {round} ahora",
    calendarVisibilityAllRevealed: "Todos los emparejamientos de la temporada están ya revelados.",
    calendarVisibilitySaveFirst: "Guarda primero el modo progresivo antes de revelar jornadas manualmente.",
    rerollEyebrow: "Evitar spoilers",
    rerollDescription: "REROLL crea otro calendario equilibrado aunque el actual sea perfecto. Se puede usar mientras no haya resultados registrados. Al regenerar se descartan programaciones, reservas y chats de los emparejamientos anteriores, pero se mantiene la Jornada de Apertura configurada.",
    rerollButton: "REROLL · Generar otro calendario",
    rerollGenerating: "Generando...",
    rerollConfirm: "Se generará otro calendario equilibrado con emparejamientos diferentes. Se borrarán programaciones, reservas y chats ligados a los emparejamientos anteriores. La Jornada de Apertura configurada se mantendrá. Solo se bloqueará si ya hay resultados registrados. ¿Continuar?",
    rerollSuccess: "Calendario equilibrado regenerado con nuevos emparejamientos.",
    rerollBlockedByResults: "No se puede hacer REROLL porque ya hay resultados registrados en esta temporada.",
  ...
  activity: {
    ...
    notificationLabels: {
      ...
      season_opening_announced: "Novedades de la Jornada 1",
    ...
    labels: {
      ...
      season_opening_announced: "Temporada",
