export const es = {
  ...
  settings: {
    ...
    profileImageTitle: "Avatar de esta liga",
    profileImageDescription: "Usa una imagen distinta en esta liga. Al quitarla volverás a la imagen de tu cuenta o al avatar predeterminado.",
    ...
    avatarCustomActive: "Avatar personalizado activo en esta liga.",
    avatarGoogleFallback: "Se usa la imagen de tu cuenta por defecto.",
    avatarInitialsFallback: "Se usan tus iniciales si no subes imagen.",
    uploadAvatar: "Subir avatar",
    removeAvatar: "Quitar avatar",
    avatarSaved: "Avatar de liga guardado.",
    avatarSaveError:
