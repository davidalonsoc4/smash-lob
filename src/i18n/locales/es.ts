export const es = {
  ...
  invites: {
    ...
    selfRegistrationProfileNotice: "No tienes que elegir un jugador: se creará o reutilizará automáticamente tu perfil en esta liga.",
  ...
  settings: {
    ...
    visualStylePlain: "Plano",
    visualStylePlainDescription: "Neutro, discreto y sin decoración adicional.",
