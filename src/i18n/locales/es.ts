export const es = {
  ...
  matches: {
    ...
    byeRoundTitle: "DESCANSAS ESTA JORNADA",
    byeRoundDescription: "No tienes partido en esta jornada. Los descansos están repartidos de forma equilibrada entre todos los jugadores.",
  },
  ...
  settings: {
    ...
    colorfulPaletteDescription: "Elige la paleta del estilo Clásico.",
    colorfulPaletteClassic: "Normal",
    colorfulPaletteClassicDescription: "Colores planos y el aspecto clásico de la aplicación.",
    competitionAccentTitle: "Acento de Competition",
    competitionAccentDescription: "Elige el color principal del modo Competition para esta liga.",
    competitionAccentLeague: "Color de la liga",
    competitionAccentLeagueDescription: "Usa el color configurado para la liga activa.",
    competitionAccentGold: "Dorado",
    competitionAccentGoldDescription: "Un dorado deportivo y cálido.",
    competitionAccentBlue: "Azul competición",
    competitionAccentBlueDescription: "Un azul limpio y energético.",
    competitionAccentGreen: "Verde pista",
    competitionAccentGreenDescription: "Un verde equilibrado y natural.",
    competitionAccentCoral: "Coral",
    competitionAccentCoralDescription: "Un coral intenso para destacar acciones.",
    competitionAccentViolet: "Violeta",
    competitionAccentVioletDescription: "Un violeta moderno y tecnológico.",
    competitionAccentIce: "Azul hielo",
    competitionAccentIceDescription: "Un azul claro con contraste frío.",
    leagueAccentColor: "Color de acento de la liga",
    leagueAccentDescription: "Se usa en Competition y en los elementos visuales de la liga.",
    leagueAccentSaveError: "No se ha podido guardar el color de acento de la liga.",
  ...
  adminSeason: {
    ...
    decreasePlayerCount: "Reducir número de jugadores",
    increasePlayerCount: "Aumentar número de jugadores",
    playersShortLabel: "jugadores",
    playerCountRangeDescription: "Selecciona entre 8 y 24 jugadores. Puedes ajustar el tamaño de uno en uno.",
    playerCountBalancedDescription: "Este tamaño permite un calendario perfectamente equilibrado: todos juegan cada jornada, sin descansos.",
    playerCountRequiresByesDescription: "Calendario equilibrado con descansos: {count} jugadores descansan en cada jornada y todos descansan el mismo número de veces.",
    ...
    calendarDescription:
      "Primero elige cómo se generarán los emparejamientos. La duración se configura por separado en el siguiente bloque.",
    seasonLengthTitle: "Duración",
    seasonLengthDescription:
      "Después elige cuántas jornadas tendrá la temporada: una duración equilibrada completa o un número personalizado.",
    durationCompleteTitle: "Equilibrada completa",
    durationCompleteDescription: "Smash & Lob calcula automáticamente una o varias vueltas completas manteniendo las condiciones de equilibrio.",
    durationRecommended: "Recomendada",
    durationCustomTitle: "Personalizada",
    durationCustomDescription: "Elige el número exacto de jornadas y se generará el calendario más equilibrado posible.",
    longMultiplierLabel: "Número de vueltas completas",
    longMultiplierHelp: "Este formato admite hasta ×{max} vueltas completas equilibradas ({rounds} jornadas) con los jugadores actuales.",
    customRoundCountLabel: "Número de jornadas",
    customRoundCountHelp: "Puedes elegir entre 1 y {max} jornadas. Si coincide con un múltiplo de una vuelta completa, se usa automáticamente una generación perfecta.",
    perfectDurationBadge: "Equilibrio completo · {count} vuelta(s) completa(s)",
    optimizedDurationBadge: "Equilibrio óptimo para {rounds} jornadas",
    ...
    extendedCalendarDescription:
      "Encadena vueltas completas, equilibradas y diferentes hasta el máximo que permita el algoritmo.",
    balancedCalendar: "Calendario equilibrado",
    balancedCalendarDescription:
      "Genera automáticamente jornadas equilibradas, repartiendo parejas y rivales y, cuando haga falta, también los descansos.",
    ...
    calendarAuditOptimized: "Optimizado",
    ...
    calendarAuditMatchesPerRound: "Partidos por jornada",
    calendarAuditMatchesPerRoundOk: "{count} partidos en cada jornada",
    calendarAuditMatchesPerRoundError: "{count} jornadas tienen un número de partidos incorrecto",
    calendarAuditSingleAppearanceError: "{count} apariciones incorrectas",
    calendarAuditMaxOneAppearance: "Máximo una aparición por jornada",
    calendarAuditMaxOneAppearanceOk: "Nadie juega más de un partido en la misma jornada",
    calendarAuditByesPerRound: "Descansos por jornada",
    calendarAuditByesPerRoundOk: "{count} descansos en cada jornada",
    calendarAuditByesPerRoundError: "{count} jornadas tienen un número de descansos incorrecto",
    calendarAuditByesPerPlayer: "Descansos por jugador",
    calendarAuditByesPerPlayerOk: "{count} descansos por jugador en la temporada",
    calendarAuditByesPerPlayerRange: "Entre {min} y {max} descansos por jugador, con diferencia máxima de 1",
    calendarAuditByesPerPlayerError: "{count} jugadores tienen un reparto de descansos incorrecto",
    calendarAuditNoConsecutiveByes: "Sin descansos consecutivos",
    calendarAuditNoConsecutiveByesOk: "Ningún jugador descansa dos jornadas seguidas",
    calendarAuditNoConsecutiveByesError: "{count} descansos consecutivos detectados",
    calendarAuditQuartets: "Cuartetos sin repetir",
    calendarAuditQuartetsOk: "Ningún grupo exacto de 4 se repite dentro de una vuelta",
    calendarAuditQuartetsError: "{count} cuartetos repetidos dentro de una vuelta",
    ...
    calendarAuditFlexiblePartners: "Ninguna pareja se repite dentro de cada vuelta.",
    calendarAuditFlexibleOpponents: "Máximo {count} partidos contra el mismo rival por vuelta.",
    calendarAuditDurationBalance: "Equilibrio de duración",
    calendarAuditDurationPerfect: "{count} vuelta(s) completa(s) y equilibrada(s)",
    calendarAuditDurationOptimized: "{complete} vuelta(s) completa(s) + {partial} jornadas optimizadas · partidos por jugador: {min}-{max}",
    calendarAuditExtendedStructure: "Sin partidos exactos repetidos",
    calendarAuditMaxPartnerFrequency: "Máximo {count} partidos como pareja; priorizando variedad.",
    calendarAuditMaxOpponentFrequency: "Máximo {count} partidos contra el mismo rival; priorizando variedad.",
    ...
    expandSeasonEyebrow: "Ampliar temporada",
    expandSeasonDescription: "Puedes regenerar el calendario para ampliarlo a doble vuelta o a una temporada larga. Con estos jugadores el máximo equilibrado es ×{max} ({rounds} jornadas).",
    expandSeasonBlockedByResults: "No se puede ampliar la temporada porque ya hay resultados registrados.",
    expandSeasonAtMaximum: "La temporada ya está en el máximo equilibrado disponible: {rounds} jornadas.",
    expandDoubleButton: "Ampliar a doble vuelta · {rounds} jornadas",
    expandLongLabel: "Duración de temporada larga",
    expandLongButton: "Ampliar a temporada larga",
    expandSeasonConfirm: "Se regenerará todo el calendario y la temporada pasará a {rounds} jornadas. Se borrarán programaciones, reservas y chats ligados a los emparejamientos anteriores; la Jornada de Apertura configurada se mantendrá. Solo continuará si no hay resultados registrados. ¿Continuar?",
    expandSeasonSuccess: "Temporada ampliada y calendario equilibrado regenerado a {rounds} jornadas.",
