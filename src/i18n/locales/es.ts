export const es = {
  ...
  adminLeague: {
    ...
    googleLocation: "Ubicación de Google",
    googleLocationPlaceholder: "Busca y selecciona el polideportivo o club",
    address: "Dirección",
    addressPlaceholder: "Dirección manual si no usas Google",
    duplicatedLocation: "Ese lugar ya está en la lista.",
    addLocation: "Añadir lugar",
    removeLocation: "Quitar",
    openMaps: "Maps",
    openWaze: "Waze",
    googleApiMissing: "La búsqueda de Google Places no está configurada. Puedes guardar el lugar con dirección manual y seguirá abriéndose en Maps/Waze por búsqueda.",
