export const es = {
  ...
  adminSeason: {
    ...
    rerollDescription: "REROLL crea otro calendario equilibrado aunque el actual sea perfecto. Solo está disponible antes de empezar y nunca sustituye partidos ya modificados o reservados.",
    rerollButton: "REROLL · Generar otro calendario",
    rerollGenerating: "Generando...",
    rerollConfirm: "Se generará otro calendario equilibrado con emparejamientos diferentes. La fecha automática de la Jornada de Apertura se mantendrá. ¿Continuar?",
