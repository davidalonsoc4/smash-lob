export const en = {
  ...
  invites: {
    ...
    selfRegistrationProfileNotice: "You do not need to choose a player: your league player will be created or reused automatically.",
  ...
  settings: {
    ...
    visualStylePlain: "Plain",
    visualStylePlainDescription: "Neutral, discreet and without extra decoration.",
