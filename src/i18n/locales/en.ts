export const en = {
  ...
  settings: {
    ...
    profileImageTitle: "League avatar",
    profileImageDescription: "Use a different image in this league. Removing it restores your account image or the default avatar.",
    ...
    avatarCustomActive: "Custom avatar active in this league.",
    avatarGoogleFallback: "Your account image is used by default.",
    avatarInitialsFallback:
      "Your initials are used if you do not upload an image.",
    uploadAvatar: "Upload avatar",
    removeAvatar: "Remove avatar",
    avatarSaved: "League avatar saved.",
    avatarSaveError:
