export const en = {
  ...
  matches: {
    ...
    byeRoundTitle: "YOU HAVE A BYE THIS ROUND",
    byeRoundDescription: "You do not have a match this round. Byes are distributed evenly across all players.",
  },
  ...
  settings: {
    ...
    colorfulPaletteDescription: "Choose the palette for Classic style.",
    colorfulPaletteClassic: "Default",
    colorfulPaletteClassicDescription: "Flat colours and the application's classic appearance.",
    competitionAccentTitle: "Competition accent",
    competitionAccentDescription: "Choose the primary colour for Competition mode in this league.",
    competitionAccentLeague: "League colour",
    competitionAccentLeagueDescription: "Use the colour configured for the active league.",
    competitionAccentGold: "Gold",
    competitionAccentGoldDescription: "A warm, sporty gold.",
    competitionAccentBlue: "Competition blue",
    competitionAccentBlueDescription: "A clean, energetic blue.",
    competitionAccentGreen: "Court green",
    competitionAccentGreenDescription: "A balanced, natural green.",
    competitionAccentCoral: "Coral",
    competitionAccentCoralDescription: "A vivid coral for prominent actions.",
    competitionAccentViolet: "Violet",
    competitionAccentVioletDescription: "A modern, technological violet.",
    competitionAccentIce: "Ice blue",
    competitionAccentIceDescription: "A clear blue with a cool contrast.",
    leagueAccentColor: "League accent colour",
    leagueAccentDescription: "Used in Competition and in the league's visual elements.",
    leagueAccentSaveError: "The league accent colour could not be saved.",
  ...
  adminSeason: {
    ...
    decreasePlayerCount: "Decrease number of players",
    increasePlayerCount: "Increase number of players",
    playersShortLabel: "players",
    playerCountRangeDescription: "Choose between 8 and 24 players. You can adjust the size one player at a time.",
    playerCountBalancedDescription: "This size allows a perfectly balanced calendar: everyone plays every round, with no byes.",
    playerCountRequiresByesDescription: "Balanced calendar with byes: {count} players sit out each round and everyone has the same number of byes.",
    ...
    calendarDescription:
      "First choose how matchups will be generated. Season length is configured separately in the next section.",
    seasonLengthTitle: "Length",
    seasonLengthDescription:
      "Then choose how many rounds the season will have: a complete balanced duration or a custom number.",
    durationCompleteTitle: "Complete balanced",
    durationCompleteDescription: "Smash & Lob automatically calculates one or more complete legs while preserving the balance rules.",
    durationRecommended: "Recommended",
    durationCustomTitle: "Custom",
    durationCustomDescription: "Choose the exact number of rounds and the most balanced calendar possible will be generated.",
    longMultiplierLabel: "Number of complete legs",
    longMultiplierHelp: "With the current players this format supports up to ×{max} complete balanced legs ({rounds} rounds).",
    customRoundCountLabel: "Number of rounds",
    customRoundCountHelp: "Choose from 1 to {max} rounds. When the value is a multiple of a complete leg, a perfect balanced generation is used automatically.",
    perfectDurationBadge: "Complete balance · {count} complete leg(s)",
    optimizedDurationBadge: "Optimal balance for {rounds} rounds",
    ...
    extendedCalendarDescription:
      "Chains complete, balanced and different legs up to the maximum supported by the algorithm.",
    balancedCalendar: "Balanced calendar",
    balancedCalendarDescription:
      "Automatically generates balanced rounds, distributing partners and opponents and, when needed, byes too.",
    ...
    calendarAuditOptimized: "Optimized",
    ...
    calendarAuditMatchesPerRound: "Matches per round",
    calendarAuditMatchesPerRoundOk: "{count} matches in every round",
    calendarAuditMatchesPerRoundError: "{count} rounds have an incorrect number of matches",
    calendarAuditSingleAppearanceError: "{count} incorrect appearances",
    calendarAuditMaxOneAppearance: "At most one appearance per round",
    calendarAuditMaxOneAppearanceOk: "No player plays more than one match in the same round",
    calendarAuditByesPerRound: "Byes per round",
    calendarAuditByesPerRoundOk: "{count} byes in every round",
    calendarAuditByesPerRoundError: "{count} rounds have an incorrect number of byes",
    calendarAuditByesPerPlayer: "Byes per player",
    calendarAuditByesPerPlayerOk: "{count} byes per player across the season",
    calendarAuditByesPerPlayerRange: "Between {min} and {max} byes per player, with a maximum difference of 1",
    calendarAuditByesPerPlayerError: "{count} players have an incorrect bye distribution",
    calendarAuditNoConsecutiveByes: "No consecutive byes",
    calendarAuditNoConsecutiveByesOk: "No player has a bye in two consecutive rounds",
    calendarAuditNoConsecutiveByesError: "{count} consecutive byes detected",
    calendarAuditQuartets: "No repeated quartets",
    calendarAuditQuartetsOk: "No exact group of 4 repeats within the same leg",
    calendarAuditQuartetsError: "{count} repeated quartets within a leg",
    ...
    calendarAuditFlexiblePartners: "No partnership repeats within each leg.",
    calendarAuditFlexibleOpponents: "At most {count} matches against the same opponent per leg.",
    calendarAuditDurationBalance: "Duration balance",
    calendarAuditDurationPerfect: "{count} complete balanced leg(s)",
    calendarAuditDurationOptimized: "{complete} complete leg(s) + {partial} optimized rounds · matches per player: {min}-{max}",
    calendarAuditExtendedStructure: "No exact repeated matches",
    calendarAuditMaxPartnerFrequency: "At most {count} matches as teammates, prioritizing variety.",
    calendarAuditMaxOpponentFrequency: "At most {count} matches against the same opponent, prioritizing variety.",
    ...
    secretPairingsTitle: "Secret pairings",
    secretPairingsCalendarHelp: "They will be revealed when the previous round finishes or, at the latest, when this round begins.",
    secretRoundDetailHelp: "This round has not been revealed yet. It will unlock when the previous one finishes or, at the latest, when its start date arrives.",
    experienceModeError: "Experience mode could not be changed.",
    experienceModeTitle: "Experience mode",
    experienceModeDescription: "Choose how you want to experience this league without changing your real administrator permissions.",
    experienceAdminTitle: "ADMINISTRATOR",
    experienceAdminDescription: "Full view with administration information and controls.",
    experiencePlayerDescription: "Experience the league like any other player. Only this setting will remain available so you can return to admin mode.",
    experienceHybridTitle: "PLAYER EXPERIENCE",
    experienceHybridDescription: "Competition screens behave like a player, while Administration remains available.",
    calendarVisibilityRevealError: "The next round could not be revealed.",
    calendarVisibilityRevealConfirm: "Round {round} pairings will be revealed. This action cannot be undone. Continue?",
    roundUnlockedTitle: "Round {round} unlocked",
    roundUnlockedBody: "You can now view the Round {round} pairings and start organising the match.",
    roundCompletedRevealBody: "Round {completedRound} has finished. You can now view the Round {nextRound} pairings and start organising the match.",
    openingRoundTitle: "Special Opening Round",
    openingRoundDescription: "Round 1 is played as an opening event. The regular cadence starts in Round 2.",
    openingRoundDateTime: "Opening Round date and time",
    openingRoundScheduledStartHelp: "Because this season has a scheduled start, the Opening Round will automatically use the same date and time. You only need to choose the location.",
    openingRoundLocation: "Opening Round location",
    openingRoundLocationPlaceholder: "Select a location",
    openingRoundAutoScheduleHelp: "When saved, every Round 1 match will automatically use this date, time and location, without assigning a court.",
    openingRoundLocked: "The Opening Round is locked once the season starts.",
    regularLeagueStart: "Regular League Start (Round 2)",
    openingRoundCreateDescription: "Round 1 will have one date and time. Round 2 will start the regular cadence.",
    openingRoundCreateAutoHelp: "This date, time and location will be applied to every Round 1 match. The specific court can be chosen later.",
    openingRoundInvalid: "Invalid date or time.",
    calendarVisibilityTitle: "Pairing visibility",
    calendarVisibilityDescription: "Choose whether players know the full calendar or discover each round progressively.",
    calendarVisibilityFullTitle: "Full calendar",
    calendarVisibilityFullDescription: "Players can view every pairing from the start.",
    calendarVisibilityProgressiveTitle: "Progressive unlock",
    calendarVisibilityProgressiveDescription: "The next round is revealed when the previous one finishes and, at the latest, when its official start date arrives.",
    newCalendarVisibilityFullDescription: "All pairings are visible from the start.",
    newCalendarVisibilityProgressiveDescription: "Each round is revealed when the previous one ends and, at the latest, when its start date arrives.",
    calendarVisibilitySave: "Save visibility",
    calendarVisibilitySaving: "Saving...",
    calendarVisibilityProgressiveEnabled: "Progressive unlock enabled.",
    calendarVisibilityFullEnabled: "Full calendar visible to players.",
    calendarVisibilitySaveError: "Calendar visibility could not be saved.",
    calendarVisibilityVisibleNow: "Visible now",
    calendarVisibilityThroughRound: "Through Round {round}",
    calendarVisibilityNoneRevealed: "No pairings revealed",
    calendarVisibilityRevealRound: "Reveal Round {round} now",
    calendarVisibilityAllRevealed: "All season pairings have already been revealed.",
    calendarVisibilitySaveFirst: "Save progressive mode before revealing rounds manually.",
    expandSeasonEyebrow: "Extend season",
    expandSeasonDescription: "You can regenerate the calendar to extend it to a double round or a long season. With these players the balanced maximum is ×{max} ({rounds} rounds).",
    expandSeasonBlockedByResults: "The season cannot be extended because results have already been recorded.",
    expandSeasonAtMaximum: "The season is already at the maximum balanced length: {rounds} rounds.",
    expandDoubleButton: "Extend to double round · {rounds} rounds",
    expandLongLabel: "Long-season length",
    expandLongButton: "Extend to long season",
    expandSeasonConfirm: "The whole calendar will be regenerated and the season will become {rounds} rounds long. Schedules, bookings and chats linked to the previous matchups will be deleted; the configured Opening Round will be kept. It will only continue if no results have been recorded. Continue?",
    expandSeasonSuccess: "Season extended and balanced calendar regenerated to {rounds} rounds.",
    rerollEyebrow: "Avoid spoilers",
    rerollDescription: "REROLL creates another balanced calendar even when the current one is perfect. It can be used while no results have been recorded. Existing scheduling, bookings and chats tied to the old pairings are discarded, while the configured Opening Round is preserved.",
    rerollButton: "REROLL · Generate another calendar",
    rerollGenerating: "Generating...",
    rerollConfirm: "Another balanced calendar with different pairings will be generated. Scheduling, bookings and chats tied to the old pairings will be removed. The configured Opening Round will be preserved. REROLL is blocked only when results already exist. Continue?",
    rerollSuccess: "Balanced calendar regenerated with new pairings.",
    rerollBlockedByResults: "REROLL is not available because this season already has recorded results.",
  ...
  notifications: {
    ...
    preferences: {
      match_schedule: { title: "Match scheduling", description: "Dates, times, courts, changes and ball-custodian assignments for your matches." },
      ...
      match_upcoming: { title: "Upcoming match", description: "A reminder before your match, including when you need to bring the balls." },
  ...
  activity: {
    ...
    notificationLabels: {
      ...
      match_ball_custodian_assigned: "Assigned to bring the balls",
      match_ball_custodian_reminder: "Reminder to bring the balls",
      match_chat_message: "New chat message",
      round_in_play: "Round in play",
      round_pairings_revealed: "Round unlocked",
    ...
    labels: {
      ...
      match_ball_custodian_assigned: "Ball duty",
      match_ball_custodian_reminder: "Ball duty",
      match_chat_message: "Chat",
      round_in_play: "Round",
      round_pairings_revealed: "Round",
