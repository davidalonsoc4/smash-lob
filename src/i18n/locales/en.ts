export const en = {
  ...
  settings: {
    ...
    colorfulPaletteOcean: "Blue and turquoise",
    colorfulPaletteOceanDescription: "Fresh, clean and bright.",
    colorfulPaletteEmerald: "Emerald green",
    colorfulPaletteEmeraldDescription: "Natural, sporty and high contrast.",
    colorfulPaletteCoral: "Coral and pink",
    colorfulPaletteCoralDescription: "Warm, energetic and expressive.",
    colorfulPaletteSunset: "Orange and purple",
    colorfulPaletteSunsetDescription: "Bold, dynamic and higher contrast.",
