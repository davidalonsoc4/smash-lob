export const en = {
  ...
  accountProfile: {
    ...
    description: "Confirm your name, preferred side and dominant hand.",
    firstName: "First name",
    lastName: "First surname",
    preferredSide: "Preferred side",
    preferredSideNone: "Not specified",
    preferredSideDrive: "Drive",
    preferredSideBackhand: "Backhand",
    preferredSideVersatile: "Versatile",
    preferredSideRequired: "Select Drive, Backhand or Versatile to continue.",
    preferredSideDescription: "Informational only, so other players know where you feel most comfortable.",
    dominantHand: "Dominant hand",
    dominantHandNone: "Not specified",
    dominantHandRight: "Right",
    dominantHandLeft: "Left",
    dominantHandRequired: "Select your dominant hand to continue.",
    dominantHandDescription: "We show it together with your preferred side as right- or left-handed.",
  ...
  roster: {
    ...
    title: "Season roster",
    remaining: "{count} places are still available.",
    complete: "The roster is complete. The organisers can now start the season.",
    availableSlot: "Available place",
    joinAction: "Join this season",
    leaveAction: "Release place",
    leaveConfirm: "Are you sure you want to release this place before the season starts?",
    joinError: "The place could not be claimed.",
  ...
  invites: {
    ...
    selfRegistrationTitle: "Register for the season",
    selfRegistrationDescription: "Your account will claim an available place using your global profile name.",
    selfRegistrationProfileNotice: "Your league profile will use your account name. If you played a previous season, you can recover that history before taking the place.",
    historicalIdentityTitle: "Did you play a previous season?",
    historicalIdentityDescription: "Select the name used in the historical season. Its matches, standings and statistics will be linked to your account and will show your current name.",
    historicalIdentityNewPlayer: "No, I am a new player",
    historicalIdentityRequired: "Choose whether you are one of the historical players or a new player.",
    historicalIdentityUnavailable: "That historical player is no longer available. Refresh the invitation and choose again.",
    historicalIdentitySelected: "History to be linked",
    selfRegistrationAction: "Accept and claim a place",
    ...
    profileIncomplete: "Complete your first name and surname first.",
    rosterFull: "The roster is already complete and there are no places left.",
    registrationClosed: "Registration for this season is already closed.",
  ...
  settings: {
    ...
    appearanceTitle: "Themes and appearance",
    appearanceDescription: "Combine the base theme, visual style and palette on this device.",
    appearancePageTitle: "Themes and appearance",
    appearancePageDescription: "Combine brightness, style and colour without changing how the application works.",
    appearanceCurrent: "Current setup",
    appearanceDeviceOnly: "Visual settings are stored only on this device.",
    themeModeTitle: "Base theme",
    themeModeDescription: "Choose a light, dark or automatic base from the device setting.",
    ...
    visualStyleColorful: "Colorful",
    visualStyleColorfulDescription: "Adds gradients, depth and the selected palette.",
    appearanceLight: "Light",
    appearanceLightDescription: "Clean and bright.",
    appearanceDark: "Dark",
    appearanceDarkDescription: "Comfortable in low light.",
    appearanceSystem: "System",
    appearanceSystemDescription: "Follows the device setting.",
    appearanceColorful: "Colorful",
    appearanceColorfulDescription: "Brighter, with soft accents and backgrounds.",
    colorfulPaletteTitle: "Colour palette",
    colorfulPaletteDescription: "Choose the main combination for Colorful mode.",
    colorfulPaletteIndigo: "Indigo and violet",
    colorfulPaletteIndigoDescription: "Balanced, technological and accented with pink.",
    colorfulPaletteMidnight: "Midnight blue and sky blue",
    colorfulPaletteMidnightDescription: "Sporty, clean and grounded in deep navy tones.",
    colorfulPaletteSage: "Sage and forest",
    colorfulPaletteSageDescription: "Natural, calm and built around muted greens.",
    colorfulPaletteBurgundy: "Burgundy and dusty pink",
    colorfulPaletteBurgundyDescription: "Elegant, warm and deliberately restrained.",
    colorfulPaletteTerracotta: "Sand and terracotta",
    colorfulPaletteTerracottaDescription: "Warm, organic and free from harsh orange tones.",
    colorfulPaletteGraphite: "Graphite and ice blue",
    colorfulPaletteGraphiteDescription: "Neutral, modern and finished with a subtle cool accent.",
    leagueSearchTitle: "Search leagues",
    leagueSearchPlaceholder: "Name, season or role",
    leagueSearchAvailable: "available leagues",
    leagueSearchAll: "All leagues",
    leagueSearchResults: "Results",
    leagueSearchNoResultsTitle: "No matching leagues",
    leagueSearchNoResultsDescription: "Try another name, season or role.",
    leagueSearchCurrent: "Current",
    leagueSearchCreator: "Creator",
    leagueSearchAdmin: "Administrator",
    leagueSearchPlayer: "Player",
    leagueSearchSpectator: "Spectator",
    leagueSearchNoSeason: "No active season",
    leagueSearchClose: "Close league search",
    leagueSearchClear: "Clear search",
    myProfileTitle: "My profile",
    myProfileDescription: "Edit your name and profile image from one compact screen.",
    profileImageTitle: "Profile image",
    profileImageDescription: "This image belongs to your account and is used in every league. Removing it restores your Google image or the default avatar.",
    ...
    accountSettingsDescription:
      "Customize the global profile image shown in all your leagues.",
    connectedEmail: "Connected email",
    joinNewExistingLeague: "Join another existing league",
    avatarCustomActive: "Custom image active on your account.",
    avatarGoogleFallback: "Your global account image is being used.",
  ...
  adminSeason: {
    ...
    selfRegistrationWaitingTitle: "Self-registration roster",
    selfRegistrationWaitingDescription: "The season will be created with {count} places. Names will appear as users join.",
    selfRegistrationCreatorNotice: "Your profile will take the first place. The calendar will be generated when the roster is complete and you start the season.",
    selfRegistrationCalendarDescription: "The balanced calendar will be generated when the season starts with every registered player.",
    rosterModeTitle: "How will the roster be formed?",
    rosterModeFixedTitle: "Roster prepared by the organisers",
    rosterModeFixedDescription: "The creator enters or selects the players before creating the season.",
    rosterModeSelfTitle: "Players register when joining",
    rosterModeSelfDescription: "Enter only the number of places. Names appear as users join with their profile.",
  ...
  notifications: {
    ...
    preferences: {
      ...
      match_chat: { title: "Chat messages", description: "Alerts when another participant writes in one of your match chats. @mentions are always notified." },
  ...
  activity: {
    ...
    notificationLabels: {
      ...
      match_chat_message: "New chat message",
      ...
      season_opening_announced: "Round 1 update",
    ...
    labels: {
      ...
      season_opening_announced: "Season",
