export const en = {
  ...
  adminLeague: {
    ...
    googleLocationPlaceholder: "Search and select the sports centre or club",
    address: "Address",
    addressPlaceholder: "Manual address if you do not use Google",
    duplicatedLocation: "That place is already in the list.",
    addLocation: "Add place",
    removeLocation: "Remove",
    openMaps: "Maps",
    openWaze: "Waze",
    googleApiMissing: "Google Places search is not configured. You can still save a manual address and it will open in Maps/Waze by search.",
    save: "Save changes",
