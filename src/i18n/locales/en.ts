export const en = {
  ...
  adminSeason: {
    ...
    rerollDescription: "REROLL creates another balanced calendar even when the current one is perfect. It is only available before the season starts and never replaces matches that have already been changed or booked.",
    rerollButton: "REROLL · Generate another calendar",
    rerollGenerating: "Generating...",
    rerollConfirm: "Another balanced calendar with different pairings will be generated. The automatic Opening Round date will be preserved. Continue?",
